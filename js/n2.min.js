!function(t) {
    ...
    var n, r, s = t.document, o = s.documentElement, a = t.setTimeout, u = t.clearTimeout, h = i._N2, f = (t.requestAnimationFrame,
    s.createElement.bind(s)), c = Object.assign, l = function(t, i) {
        return t.dataset[i]
    }, v = function(t, i) {
    ...
    function() {
        ...
        function u() {
            var t = performance.now()
              , n = s;
            s = [];
            for (var r = n.length - 1; r >= 0 && (n.pop().call(),
            !(performance.now() - t > 7)); r--)
                ;
        ...
        function p(i, r, s) {
            ...
            if (d(i) || n[i]) {
                ...
                Promise.all(o).then(function(t) {
                    h[i] = "function" != typeof s || s.call(h),
                    t()
                }
                .bind(this, n[i])),
                delete n[i]
        ...
        i.N2DISABLESCHEDULER ? (h.d = p,
        h.r = g) : (h.d = function(t, i, n) {
            c(p.bind(this, t, i, n))
        }
        ,
        h.r = function(t, i) {
    ...
    h.r("nextend-frontend", (function() {
        ...
        "complete" === s.readyState)
            ...
            o.indexOf("Safari") > 0 && -1 === o.indexOf("Chrome") && (r = setInterval((function() {
                "interactive" !== s.readyState && "complete" !== s.readyState || (h.d("windowLoad"),
                clearInterval(r))
            }
            ), 2e3)),
            t = "load",
    ...
    i.ResizeObserver || (i.ResizeObserver = function() {
        ...
        var f = 20
          ...
          , v = function() {
            ...
            t.prototype.connect_ = function() {
                n && !this.connected_ && (s.addEventListener("transitionend", this.onTransitionEnd_),
            ...
            t.prototype.disconnect_ = function() {
                n && this.connected_ && (s.removeEventListener("transitionend", this.onTransitionEnd_),
                i.removeEventListener("resize", this.refresh),
                this.mutationsObserver_ && this.mutationsObserver_.disconnect(),
                this.mutationEventsAdded_ && s.removeEventListener("DOMSubtreeModified", this.refresh),
                this.mutationsObserver_ = null,
                this.mutationEventsAdded_ = !1,
                this.connected_ = !1)
            }
        ...
        function M(t) {
            ...
            var r = p(t).getComputedStyle(t)
              ...
              , u = m(r.width)
              , h = m(r.height);
            if ("border-box" === r.boxSizing && (Math.round(u + o) !== i && (u -= w(r, "left", "right") + o),
    ...
    function() {
        ...
        n = /Safari/i.test(navigator.userAgent) && !/Chrom[ei]/i.test(navigator.userAgent) ? function(t, i, n, r) {
            var s = "";
            return r && (t || i || n) ? "translate3d(" + (t || 0) + "px, " + (i || 0) + "px, " + (n || 0) + "px) " : ((t || i) && (s += "translate(" + (t || 0) + "px, " + (i || 0) + "px) "),
            n && (s += "translateZ(" + n + "px) "),
            s)
        }
        : function(t, i, n, r) {
        ...
        class a {
            ...
            render() {
                for (let i of this.S) {
                    ...
                    case "filter":
                        ...
                        break;
                    case "n2AutoAlpha":
                        0 === this.opacity ? this.A || (this.A = !0,
                        this.I("data-force-hidden", "")) : this.A && (this.A = !1,
                        this.R("data-force-hidden"));
                        continue;
                    case "opacity":
                        this.P.n2AutoAlpha && (0 === t ? this.A || (this.A = !0,
                        this.I("data-force-hidden", "")) : this.A && (this.A = !1,
                        this.R("data-force-hidden")));
                        break;
                    case "width":
            ...
            F() {
                let {xP: t, yP: i, x: s, y: o, z: a, xAbs: u, yAbs: h, xPAbs: f, yPAbs: c, parallaxX: l, parallaxY: v, parallaxRotationX: d, parallaxRotationY: p, layerRotation: g, rotationZ: m, rotationY: w, rotationX: y, scaleX: b, scaleY: M, scaleZ: x, skewX: _, skewY: O, transformPerspective: k, force3D: P} = this.P
                  , S = "";
                return k && (S += "perspective(" + k + "px) "),
                (t || i) && (S += "translate(" + (t || 0) + "%, " + (i || 0) + "%) "),
                (u || h) && (S += "translate(" + (u || 0) + "px, " + (h || 0) + "px) "),
                (f || c) && (S += "translate(" + (f || 0) + "%, " + (c || 0) + "%) "),
                S += n(s, o, a, P),
                _ && (S += "skewX(" + _ + "deg) "),
                O && (S += "skewY(" + O + "deg) "),
                (l || v) && (S += "translate(" + (l || 0) + "px, " + (v || 0) + "px) "),
                g && (S += "rotate(" + g + "deg) "),
                m && (S += "rotate(" + m + "deg) "),
        ...
        class u {
            constructor(t, i) {
                ...
                for (var n = 0; n < t.length; n++)
                    t[n] && this.T.push(w.i(t[n], i))
            }
            setValues(t) {
                for (var i = 0; i < this.T.length; i++)
                    this.T[i].setValues(t)
            }
        }
        var f = {}
          , l = function(t) {
          ...
          , v = function(t, i, n) {
            Object.getOwnPropertyDescriptor(a.prototype, t) || (i === r && (i = ""),
            n === r && (n = t),
            f[n] === r && (f[n] = []),
            f[n].push(t),
            o[t] = i,
            Object.defineProperty(a.prototype, t, {
                get: function() {
                    return this.P[t] === r && (this.P[t] = o[t]),
                    this.P[t]
                },
                set: function(i) {
                    i instanceof Function && (i = i()),
                    this.P[t] !== i && (this.P[t] = i,
                    this.S.add(n),
                    s.add(this))
                }
            }),
    ...
    customElements.define("ss3-force-full-width", class extends HTMLElement {
        ...
        doResize() {
            ...
            if (this.fullWidthTo) {
                ...
                r = s.width,
                t = this.Z ? -r + s.right : s.left
            }
            var o, a, u = r > 0 ? r : n.clientWidth, h = i.getComputedStyle(this.parentNode);
            o = this.Z ? u - this.parentNode.getBoundingClientRect().right - parseInt(h.getPropertyValue("padding-right")) - parseInt(h.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(h.getPropertyValue("padding-left")) - parseInt(h.getPropertyValue("border-left-width")) + t,
            o += a = o % 1,
            u -= Math.floor(a),
            (this._width - u <= 0 || this._width - u > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.V.x = o,
            this._offset = o,
            0 !== o && this.classList.add("n2-ss-no-bga-fixed")),
            this._width !== u && (this.V.width = u,
            this._width = u)),
    ...
    customElements.define("ss3-loader", class extends HTMLElement {
        ...
        removePromise(t) {
            ...
            i > -1 && (this.q.splice(i, 1),
            this.syncStyle())
        }
        syncStyle() {
            this.q.length ? this.H || (this.H = a(this.show.bind(this), 100)) : (this.H && (u(this.H),
            delete this.H),
            this.display = "")
        }
    }
    ...
    i.n2const.isTablet = !i.n2const.isPhone && (/Android|iPad|tablet|Silk/i.test(navigator.userAgent) || y),
    ...
    h._preventClick = function() {
        h._shouldPreventClick || (h._shouldPreventClick = !0,
        a((function() {
            h._shouldPreventClick = !1
        }
        ), 300))
    ...
    h.d("ImagesLoaded", (function() {
        return function(t) {
            ...
            for (var r = 0; r < i.length; r++) {
                var s = i[r];
                s.loading = "eager",
                s.complete ? s.naturalWidth || n.push(new Promise(function(t) {
                    a(t, 16)
                }
    ...
    h.d("UniversalPointer", (function() {
        ...
        function f(i, r, a) {
            ...
            t ? u.addGlobalEventListener("pointerdown", (function(t) {
                t.isPrimary && (u.startComplexInteraction(t.currentTarget),
                u.addLocalEventListener(o, "pointerup", (function(i) {
                    i.isPrimary && t.pointerId === i.pointerId && (Math.abs(i.clientX - t.clientX) < 10 && Math.abs(i.clientY - t.clientY) < 10 ? u.click(i) : u.clear(),
                ...
                u.addLocalEventListener(o, "touchend", (function(i) {
                    Math.abs(i.changedTouches[0].clientX - t.changedTouches[0].clientX) < 10 && Math.abs(i.changedTouches[0].clientY - t.changedTouches[0].clientY) < 10 ? u.click(i) : u.clear(),
                    u.endComplexInteraction()
                }
                ), {
                    passive: !0
        ...
        function d(i, r, s) {
            ...
            t ? (u.addGlobalEventListener("pointerenter", (function(e) {
                e.isPrimary && (u.clearTimeouts(),
                u.enter(e) && "mouse" !== e.pointerType && (u.addLocalEventListener(o, "pointerdown", (function(e) {
            ...
            n && u.addGlobalEventListener("touchstart", (function(e) {
                u.preventMouse = !0,
                u.clearTimeouts(),
                u.enter(e) && (u.addLocalEventListener(o, "touchstart", (function(e) {
        ...
        s.prototype.addLocalEventListener = function(t, i, n, r) {
            this.localListeners.push([t, i, n, r]),
            t.addEventListener(i, n, r)
        }
        ,
    ...
    h.d("EventBurrito", (function() {
        ...
        return function(u, h) {
            ...
            }, y = {}, b = {}, M = [], x = !0, _ = w.pointerEvents ? 1 : 0, O = [["touchstart", "touchmove", "touchend", "touchcancel"], ["pointerdown", "pointermove", "pointerup", "pointercancel", "pointerleave"], ["mousedown", "mousemove", "mouseup", "", "mouseleave"]], k = [function(e) {
            ...
            function C(e, t) {
                if ((e.isPrimary === r || e.isPrimary) && !o && (l = [],
                x = !0,
                !k[m = t](e) && !P(e.target)))
                    if (("mousedown" === e.type || "pointerdown" === e.type && "mouse" === e.pointerType) && e.target.closest(".n2-ss-text")) {
                        var i = p(e.target, "click", (function(t) {
                            i(),
                            Math.abs(e.clientX - t.clientX) < 10 && Math.abs(e.clientY - t.clientY) < 10 && d(e.target, "n2click")
                        }
                        ));
                        a(i, 2e3)
                    } else
                        o = !0,
                        0 !== m && l.push(p(s, O[m][1], A, {
                            passive: !1,
                            capture: !0
                        })),
                        l.push(p(s, O[m][2], R, {
            ...
            function A(t) {
                (t.isPrimary === r || t.isPrimary) && ("x" === f.axis && (!f.preventScroll && v || k[m](t)) || P(t.target) || (F(t),
                (Math.abs(b.x) > 10 || Math.abs(b.y) > 10) && (x = !1),
                v === r && 2 !== m && (v = Math.abs(b.x) < Math.abs(b.y) && !f.preventScroll) || f.move(t, y, b, g) && f.preventDefault && S(t)))
            }
            function I(t) {
            ...
            f.mouse && 0 === _ && M.push(p(u, O[2][0], (function(e) {
                C(e, 2)
            }
            ))),
    ...
    h.d("GSAP", (function() {
        ...
        !function(e) {
            ...
            function $(t) {
                ...
                for (i = t.length; i--; )
                    t[i] && (t[i]._gsap || (t[i]._gsap = new Xi(t[i],e))) || t.splice(i, 1);
                return t
            }
            function y(t) {
            ...
            function I(t, e) {
                for (var i in e)
                    "__proto__" !== i && "constructor" !== i && "prototype" !== i && (t[i] = f(e[i]) ? I(t[i] || (t[i] = {}), e[i]) : e[i]);
                return t
            }
            function R(t, e) {
                var i, n = {};
            ...
            function Y(t, e) {
                var i = t._dp;
                return i && i.smoothChildTiming && t._ts && (t._start = x(i._time - (0 < t._ts ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)),
                X(t),
                i._dirty || D(i, t)),
                t
            }
            function j(t, e) {
                var i;
                if ((e._time || e._initted && !e._dur) && (i = L(t.rawTime(), e),
                (!e._dur || bi(0, e.totalDuration(), i) - e._tTime > Zt) && e.render(i, !0)),
            ...
            function U(t, e, i, n) {
                return Zi(t, e),
                t._initted ? !i && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && Ot !== Ci.frame ? (fi.push(t),
                t._lazy = [e, n],
                1) : void 0 : 1
            }
            function W(t, e, i, n) {
            ...
            function V(t, e) {
                ...
                return r(e) && (isNaN(e) || e in s) ? "<" === (i = e.charAt(0)) || ">" === i ? ("<" === i ? o._start : o.endTime(0 <= o._repeat)) + (parseFloat(e.substr(1)) || 0) : (i = e.indexOf("=")) < 0 ? (e in s || (s[e] = a),
                s[e]) : (n = +(e.charAt(i - 1) + e.substr(i + 1)),
                1 < i ? V(t, e.substr(0, i - 1)) + n : a + n) : null == e ? a : +e
            }
            function q(t, e) {
                return t || 0 === t ? e(t) : e
            }
            ...
            function K(t) {
                ...
                function(t, e, r) {
                    ...
                    if (!_) {
                        ...
                        for (_ = u[M] = [],
                        s = h ? Math.min(b, M) * l - .5 : o % b,
                        f = h ? M * v / b - .5 : o / b | 0,
                        y = Wt,
                        m = w = 0; m < M; m++)
                            d = m % b - s,
                            p = f - (m / b | 0),
                            _[m] = g = c ? Math.abs("y" === c ? p : d) : Ht(d * d + p * p),
                            w < g && (w = g),
                            g < y && (y = g);
                        "random" === o && J(_),
                        _.max = w - y,
                        _.min = y,
                        _.v = M = (parseFloat(i.amount) || parseFloat(i.each) * (M < b ? M - 1 : c ? "y" === c ? M / b : b : Math.max(b, M / b)) || 0) * ("edges" === o ? -1 : 1),
                        _.b = M < 0 ? a - M : a,
                        _.u = G(i.amount || i.each) || 0,
                        n = n && M < 0 ? Ti(n) : n
                    }
                    return M = (_[t] - _.min) / _.max || 0,
            ...
            function it(t, i) {
                var n, r, e = ti(t);
                return !e && f(t) && (n = e = t.radius || Wt,
                t.values ? (t = xi(t.values),
                (r = !o(t[0])) && (n *= n)) : t = tt(t.increment)),
                q(i, e ? s(t) ? function(i) {
                    return r = t(i),
                    Math.abs(r - i) <= n ? r : i
                }
                : function(i) {
                    for (var e, s, a = parseFloat(r ? i.x : i), u = parseFloat(r ? i.y : 0), h = Wt, f = 0, c = t.length; c--; )
                        (e = r ? (e = t[c].x - a) * e + (s = t[c].y - u) * s : Math.abs(t[c] - a)) < h && (h = e,
                        f = c);
                    return f = !n || h <= n ? t[f] : i,
                    r || f === i || o(i) ? f : f + G(i)
                }
                : tt(t))
            }
            ...
            function et(t) {
                for (var e, i, n, r, s = 0, o = ""; ~(e = t.indexOf("random(", s)); )
                    ...
                    o += t.substr(s, e - s) + nt(r ? i : +i[0], r ? 0 : +i[1], +i[2] || 1e-5),
                    s = n + 1;
            ...
            function ut(t, e, i) {
                ...
                if (!d) {
                    ...
                    Pi[t])
                        ...
                        if (t.length < 6 && (t = "#" + (n = t.charAt(1)) + n + (r = t.charAt(2)) + r + (s = t.charAt(3)) + s + (5 === t.length ? t.charAt(4) + t.charAt(4) : "")),
                        9 === t.length)
                            return [(d = parseInt(t.substr(1, 6), 16)) >> 16, d >> 8 & ki, d & ki, parseInt(t.substr(7), 16) / 255];
                        ...
                        e) {
                            ...
                            a = +d[0] % 360 / 360,
                            u = d[1] / 100,
                            n = 2 * (h = d[2] / 100) - (r = h <= .5 ? h * (u + 1) : h + u - h * u),
                            3 < d.length && (d[3] *= 1),
                            d[0] = at(a + 1 / 3, n, r),
                            d[1] = at(a, n, r),
                            d[2] = at(a - 1 / 3, n, r);
                    else
                        d = t.match(ii) || Pi.transparent;
                    d = d.map(Number)
                }
                return e && !v && (n = d[0] / ki,
                r = d[1] / ki,
                ...
                f === c ? a = u = 0 : (l = f - c,
                u = .5 < h ? l / (2 - f - c) : l / (f + c),
                a = f === n ? (r - s) / l + (r < s ? 6 : 0) : f === r ? (s - n) / l + 2 : (n - r) / l + 4,
                a *= 60),
                d[0] = ~~(a + .5),
                d[1] = ~~(100 * u + .5),
                d[2] = ~~(100 * h + .5)),
            ...
            function ft(t, e, i) {
                ...
                (n = i.c).join(a) !== s.c.join(a)))
                    for (o = (r = t.replace(Si, "1").split(ri)).length - 1; f < o; f++)
                        a += r[f] + (~n.indexOf(f) ? u.shift() || h + "0,0,0,0)" : (s.length ? s : u.length ? u : i).shift());
                if (!r)
                    for (o = (r = t.split(Si)).length - 1; f < o; f++)
                        a += r[f] + u[f];
                return a + r[o]
            }
            function ct(t) {
            ...
            function lt(t, e) {
                for (var i, n = t._first; n; )
                    n instanceof Ni ? lt(n, e) : !n.vars.yoyoEase || n._yoyo && n._repeat || n._yoyo === e || (n.timeline ? lt(n.timeline, e) : (i = n._ease,
                    n._ease = n._yEase,
                    n._yEase = i,
                    n._yoyo = e)),
                    n = n._next
            ...
            function vt(t, e, i, n) {
                ...
                return M(t, (function(t) {
                    ...
                    s)
                        Ii[r + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = Ii[t + "." + e] = s[e]
                }
                )),
                s
            }
            ...
            var mt, wt, yt, bt, Mt, xt, _t, Ot, kt, Pt, St, Ft, Ct, At, It, Rt, Et, Tt, zt, Dt, Bt, Lt, Xt, Yt, jt, Nt, Qt = {
                ...
                overwrite: !1,
                delay: 0
            }, Wt = 1e8, Zt = 1 / Wt, Vt = 2 * Math.PI, qt = Vt / 4, Gt = 0, Ht = Math.sqrt, $t = Math.cos, Jt = Math.sin, Kt = "function" == typeof ArrayBuffer && ArrayBuffer.isView || function() {}
            , ti = Array.isArray, ii = /(?:-?\.?\d|\.)+/gi, ni = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, ri = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, ei = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, si = /[+-]=-?[.\d]+/, oi = /[#\-+.]*\b[a-z\d-=+%.]+/gi, ai = /[\d.+\-=]+(?:e[-+]\d*)*/i, ui = {}, hi = {}, fi = [], ci = {}, li = {}, vi = {}, di = 30, pi = [], gi = "", mi = function(t, e) {
                for (var i in e)
                    t[i] = e[i];
                return t
            }, wi = function(t, e) {
            ...
            At = {
                ...
                wake: function() {
                    ...
                    Mt = yt.document || {},
                    ui.gsap = gn,
                    (yt.gsapVersions || (yt.gsapVersions = [])).push(gn.version),
                ...
                sleep: function() {
                    (Ct ? yt.cancelAnimationFrame : u)(St),
                    Pt = 0,
                    Ft = w
                },
                ...
                return t && (s(t) ? t : Ii[t] || function(t) {
                    ...
                    return i && 1 < e.length && i.config ? i.config.apply(null, ~t.indexOf("{") ? [function(t) {
                        for (var e, i, n, r = {}, s = t.substr(1, t.length - 3).split(":"), o = s[0], a = 1, u = s.length; a < u; a++)
                            ...
                            n = i.substr(0, e),
                            r[o] = isNaN(n) ? n.replace(Ei, "").trim() : +n,
                            o = i.substr(e + 1).trim();
                        return r
                    }(e[1])] : function(t) {
                        var e = t.indexOf("(") + 1
            ...
            function Di(t) {
                var e, i, n, r, s = Et() - Bt, o = !0 === t;
                if (Tt < s && (Dt += s - zt),
                (0 < (e = (n = (Bt += s) - Dt) - Xt) || o) && (r = ++At.frame,
                It = n - 1e3 * At.time,
                At.time = n /= 1e3,
                Xt += e + (Lt <= e ? 4 : Lt - e),
                i = 1),
            ...
            Ii.SteppedEase = Ii.steps = ui.SteppedEase = {
                config: function(t, e) {
                    void 0 === t && (t = 1);
                    var i = 1 / t
                      , n = t + (e ? 0 : 1)
            ...
            Ut.ease = Ii["quad.out"],
            M("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", (function(t) {
            ...
            Li.totalTime = function(t, e) {
                ...
                if (i && i.smoothChildTiming && this._ts) {
                    for (Y(this, t),
                    !i._dp || i.parent || j(i, this); i.parent; )
            ...
            Li.paused = function(t) {
                ...
                this._ts = this._act = 0) : (Ai(),
                this._ts = this._rts,
                this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= Zt) && Math.abs(this._zTime) !== Zt))),
                this) : this._ps
            }
            ,
            ...
            var Ni = function(i) {
                ...
                return e.to = function(t, e, i, n) {
                    return new Hi(t,O(arguments, 0, this),V(this, o(e) ? n : i)),
                    this
                }
                ,
                e.from = function(t, e, i, n) {
                    return new Hi(t,O(arguments, 1, this),V(this, o(e) ? n : i)),
                    this
                }
                ,
                e.fromTo = function(t, e, i, n, r) {
                    return new Hi(t,O(arguments, 2, this),V(this, o(e) ? r : n)),
                    this
                }
                ,
                ...
                e.render = function(t, e, i) {
                    var n, r, s, o, a, u, h, f, c, l, v, d, p = this._time, g = this._dirty ? this.totalDuration() : this._tDur, m = this._dur, w = this !== wt && g - Zt < t && 0 <= t ? g : t < Zt ? 0 : t, y = this._zTime < 0 != t < 0 && (this._initted || !m);
                    if (w !== this._tTime || i || y) {
                        if (p !== this._time && m && (w += this._time - p,
                        t += this._time - p),
                        n = w,
                        c = this._start,
                        u = !(f = this._ts),
                        ...
                        this._repeat) {
                            ...
                            o !== l && !this._lock) {
                                ...
                                p && p !== this._time || u != !this._ts || this.vars.onRepeat && !this.parent && !this._act)
                                    return this;
                                if (m = this._dur,
                                g = this._tDur,
                                M && (this._lock = 2,
                        ...
                        p <= n && 0 <= t)
                            for (r = this._first; r; ) {
                                ...
                                (r._act || n >= r._start) && r._ts && h !== r) {
                                    ...
                                    if (r.render(0 < r._ts ? (n - r._start) * r._ts : (r._dirty ? r.totalDuration() : r._tDur) + (n - r._start) * r._ts, e, i),
                            ...
                            for (var _ = t < 0 ? t : n; r; ) {
                                ...
                                (r._act || _ <= r._end) && r._ts && h !== r) {
                                    if (r.parent !== this)
                                        return this.render(t, e, i);
                                    if (r.render(0 < r._ts ? (_ - r._start) * r._ts : (r._dirty ? r.totalDuration() : r._tDur) + (_ - r._start) * r._ts, e, i),
                                    n !== this._time || !this._ts && !u) {
                                        h = 0,
                                        s && (w += this._zTime = _ ? -Zt : Zt);
                                        break
                                    }
                                }
                                r = s
                        ...
                        (w === g && g >= this.totalDuration() || !w && p) && (c !== this._start && Math.abs(f) === Math.abs(this._ts) || this._lock || (!t && m || !(w === g && 0 < this._ts || !w && this._ts < 0) || z(this, 1),
                        e || t < 0 && !p || !w && !p || (Oi(this, w === g ? "onComplete" : "onReverseComplete", !0),
                ...
                e.getChildren = function(t, e, i, n) {
                    ...
                    for (var r = [], s = this._first; s; )
                        s._start >= n && (s instanceof Hi ? e && r.push(s) : (i && r.push(s),
                ...
                ,
                e.remove = function(t) {
                    return r(t) ? this.removeLabel(t) : s(t) ? this.killTweensOf(t) : (T(this, t),
                ...
                e.totalTime = function(t, e) {
                    ...
                    !this._dp && this._ts && (this._start = x(Ci.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))),
                ...
                e.getTweensOf = function(t, e) {
                    for (var i, n = [], r = xi(t), s = this._first, a = o(e); s; )
                        s instanceof Hi ? _(s._targets, r) && (a ? (!Ui || s._initted && s._ts) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && n.push(s) : (i = s.getTweensOf(r, e)).length && n.push.apply(n, i),
                        s = s._next;
                    return n
                }
                ,
                ...
                e.totalDuration = function(t) {
                    ...
                    if (s._dirty) {
                        for (n = s.parent; o; )
                            ...
                            N(s, o, i - o._delay, 1)._lock = 0) : a = i,
                            i < 0 && o._ts && (r -= i,
            ...
            function Qi(t, e, i, n, o, a) {
                ...
                if (li[t] && !1 !== (u = new li[t]).init(o, u.rawVars ? e[t] : function(t, e, i, n, o) {
                    ...
                    for (a in t)
                        u[a] = Vi(t[a], o, e, i, n);
                    return u
                }(e[t], n, o, a, i), i, n, a) && (i._pt = h = new cn(i._pt,o,t,0,1,u.render,u,0,u.priority),
                i !== kt))
                    for (c = i._ptLookup[i._targets.indexOf(o)],
                    l = u._props.length; l--; )
                        c[u._props[l]] = h;
                return u
            }
            ...
            var Ui, Wi = function(t, e, i, n, o, a, u, h, f) {
                s(n) && (n = n(o || 0, t, a));
                var c, l = t[e], v = "get" !== i ? i : s(l) ? f ? t[e.indexOf("set") || !s(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](f) : t[e]() : l, d = s(l) ? f ? nn : tn : Ki;
                if (r(n) && (~n.indexOf("random(") && (n = et(n)),
                "=" === n.charAt(1) && (n = parseFloat(v) + parseFloat(n.substr(2)) * ("-" === n.charAt(0) ? -1 : 1) + (G(v) || 0))),
                v !== n)
                    return isNaN(v * n) ? (l || e in t || p(e, n),
                    function(t, e, i, n, r, s, o) {
                        ...
                        u = i.match(ei) || []; a = ei.exec(n); )
                            ...
                            g = ei.lastIndex);
                        return p.c = g < n.length ? n.substring(g, n.length) : "",
                        p.fp = o,
                        (si.test(n) || v) && (p.e = 0),
                        this._pt = p
                    }
                    .call(this, t, e, v, n, d, h || Qt.stringFilter, f)) : (c = new cn(this._pt,t,e,+v || 0,n - (v || 0),"boolean" == typeof l ? sn : en,0,d),
                    f && (c.fp = f),
                    u && c.modifier(u, this, t),
                    this._pt = c)
            }, Zi = function t(e, i) {
                var n, r, s, o, a, u, h, f, l, v, d, p, g, m = e.vars, w = m.ease, b = m.startAt, M = m.immediateRender, x = m.lazy, _ = m.onUpdate, O = m.onUpdateParams, P = m.callbackScope, S = m.runBackwards, F = m.yoyoEase, A = m.keyframes, I = m.autoRevert, E = e._dur, T = e._startAt, D = e._targets, B = e.parent, L = B && "nested" === B.data ? B.parent._targets : D, X = "auto" === e._overwrite && !mt, Y = e.timeline;
                if (!Y || A && w || (w = "none"),
                ...
                e._ease = F),
                !Y) {
                    if (p = (f = D[0] ? y(D[0]).harness : 0) && m[f.prop],
                    n = R(m, hi),
                    T && T.render(-1, !0).kill(),
                    b)
                    ...
                    x = E && c(x) || x && !E,
                    r = 0; r < D.length; r++) {
                        if (h = (a = D[r])._gsap || $(D)[r]._gsap,
                        e._ptLookup[r] = v = {},
                        ci[h.id] && fi.length && k(),
                        d = L === D ? r : L.indexOf(a),
                        f && !1 !== (l = new f).init(a, p || n, e, d, L) && (e._pt = o = new cn(e._pt,a,l.name,0,1,l.render,l,0,l.priority),
                        ...
                        !f || p)
                            for (s in n)
                                li[s] && (l = Qi(s, n, e, d, a, L)) ? l.priority && (u = 1) : v[s] = o = Wi.call(e, a, s, "get", n[s], d, L, 0, m.stringFilter);
            ...
            }, qi = gi + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Gi = (qi + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Hi = function(i) {
                function s(e, t, r, s) {
                    var a;
                    "number" == typeof t && (r.duration = t,
                    t = r,
                    r = null);
                    var u, h, l, d, p, m, y, b, M = (a = i.call(this, s ? t : E(t), r) || this).vars, _ = M.duration, O = M.delay, k = M.immediateRender, P = M.stagger, S = M.overwrite, F = M.keyframes, A = M.defaults, I = M.scrollTrigger, R = M.yoyoEase, T = a.parent, z = (ti(e) || Kt(e) ? o(e[0]) : "length"in t) ? [e] : xi(e);
                    if (a._targets = z.length ? $(z) : g("GSAP target " + e + " not found. https://greensock.com", !Qt.nullTargetWarn) || [],
                    a._ptLookup = [],
                    a._overwrite = S,
                    F || P || v(_) || v(O)) {
                        if (t = a.vars,
                        ...
                        F)
                            ...
                            f(P))
                                for (p in P)
                                    ~qi.indexOf(p) && ((b = b || {})[p] = P[p]);
                            for (h = 0; h < d; h++) {
                                for (p in l = {},
                                t)
                                    Gi.indexOf(p) < 0 && (l[p] = t[p]);
                                l.stagger = 0,
                                R && (l.yoyoEase = R),
                                b && mi(l, b),
                                m = z[h],
                                ...
                                !P && 1 === d && l.delay && (a._delay = O = l.delay,
                                a._start += O,
                                l.delay = 0),
                                u.to(m, l, y(h, m, z))
                            }
                        ...
                        a.timeline = 0;
                    return !0 !== S || mt || (Ui = n(a),
                    wt.killTweensOf(z),
                    Ui = 0),
                    T && j(T, n(a)),
                    (k || !_ && !F && a._start === x(T._time) && c(k) && function t(i) {
                        return !i || i._ts && t(i.parent)
                    }(n(a)) && "nested" !== T.data) && (a._tTime = -Zt,
                    a.render(Math.max(0, -O))),
                    I && Q(n(a), I),
                    a
                }
                t(s, i);
                ...
                return e.render = function(t, e, i) {
                    var n, r, s, o, a, u, h, f, c, l = this._time, v = this._tDur, d = this._dur, p = v - Zt < t && 0 <= t ? v : t < Zt ? 0 : t;
                    if (d) {
                        if (p !== this._tTime || !t || i || !this._initted && this._tTime || this._startAt && this._zTime < 0 != t < 0) {
                            ...
                            r = this._pt; r; )
                                r.r(h, r.d),
                                r = r._next;
                            f && f.render(t < 0 ? t : !n && u ? -Zt : f._dur * h, e, i) || this._startAt && (this._zTime = t),
                            ...
                            p !== this._tDur && p || this._tTime !== p || (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0),
                            !t && d || !(p === this._tDur && 0 < this._ts || !p && this._ts < 0) || z(this, 1),
                            e || t < 0 && !l || !p && !l || (Oi(this, p === v ? "onComplete" : "onReverseComplete", !0),
                            !this._prom || p < v && 0 < this.timeScale() || this._prom()))
                        }
                    } else
                        !function(t, e, i, n) {
                            ...
                            }(t) || (t._ts < 0 || t._dp._ts < 0) && "isFromStart" !== t.data && "isStart" !== t.data) ? 0 : 1, h = t._rDelay, f = 0;
                            if (h && t._repeat && (f = bi(0, t._tDur, e),
                            s = wi(f, h),
                            o = wi(t._tTime, h),
                            t._yoyo && 1 & s && (u = 1 - u),
                            s !== o && (a = 1 - u,
                            ...
                            u !== a || n || t._zTime === Zt || !e && t._zTime) {
                                ...
                                i || (Oi(t, u ? "onComplete" : "onReverseComplete", !0),
                                t._prom && t._prom()))
                            } else
                                t._zTime || (t._zTime = e)
                        }(this, t, e, i);
                ...
                e.kill = function(t, e) {
                    ...
                    if (this.timeline) {
                        ...
                        return this.timeline.killTweensOf(t, e, Ui && !0 !== Ui.vars.overwrite)._first || ot(this),
                        this.parent && i !== this.timeline.totalDuration() && W(this, this._dur * this.timeline._tDur / i, 0, 1),
                        this
                    }
                    ...
                    f = c.length; f--; )
                        if (~l.indexOf(c[f]))
                            ...
                            a = e),
                            a)
                                (h = s && s[u]) && ("kill"in h.d && !0 !== h.d.kill(u) || T(this, h, "_pt"),
                                delete s[u]),
                                "all" !== o && (o[u] = 1);
                    return this._initted && !this._pt && d && ot(this),
                    this
                }
                ,
                s.to = function(t, e, i) {
            ...
            var Ki = function(t, e, i) {
              ...
              , hn = function(t) {
                for (var e, i, n = this._pt; n; )
                    i = n._next,
                    n.p === t && !n.op || n.op === t ? T(this, n, "_pt") : n.dep || (e = 1),
                    n = i;
                return !e
            }
              , fn = function(t) {
            ...
            var vn = {
                    ...
                    e.forEach((function(t) {
                        return function(t) {
                            ...
                            t !== n) {
                                ...
                                li[n.prop = e] = n,
                                t.targetTest && (pi.push(n),
                                hi[e] = 1),
                                e = ("css" === e ? "CSS" : e.charAt(0).toUpperCase() + e.substr(1)) + "Plugin"
                            }
                            m(e, n),
                            t.register && t.register(gn, n, cn)
                        }(t)
                    }
                    ))
                },
                ...
                getProperty: function(t, i, e, n) {
                    ...
                    var s = y(t || {}).get
                      , o = e ? F : S;
                    return "native" === e && (e = ""),
                    t ? i ? o((li[i] && li[i].get || s)(t, i, e, n)) : function(i, e, n) {
                ...
                defaults: function(t) {
                    return t && t.ease && (t.ease = zi(t.ease, Ut.ease)),
                    I(Ut, t || {})
                },
                config: function(t) {
                    return I(Qt, t || {})
                ...
                exportRoot: function(e, t) {
                    void 0 === e && (e = {});
                    var i, n, r = new Ni(e);
                    for (r.smoothChildTiming = c(e.smoothChildTiming),
                    wt.remove(r),
                    r._dp = 0,
                    r._time = r._tTime = wt._time,
                    i = wt._first; i; )
                        n = i._next,
                        !t && !i._dur && i instanceof Hi && i.vars.onComplete === i._targets[0] || N(r, i, i._start - i._delay),
                        i = n;
                    return N(wt, r, 0),
                    r
                },
                    ...
                    init: function(t, n, e) {
                        e._onInit = function(t) {
                            ...
                            !function(t, e) {
                                ...
                                for (i in e)
                                    for (n = s.length; n--; )
                                        (r = (r = t._ptLookup[n][i]) && r.d) && (r._pt && (r = dn(r, i)),
            ...
            function In() {
                void 0 !== i && i.document && ($n = i.document,
            ...
            function Rn(t) {
                var e, i = Cn("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, r = this.nextSibling, s = this.style.cssText;
                if (Jn.appendChild(i),
                i.appendChild(this),
            ...
            function Dn(t, e) {
                if (e) {
                    ...
                    i.removeProperty(e.replace(kr, "-$1").toLowerCase())) : i.removeAttribute(e)
                }
            }
            ...
            function Ln(t, e, i, n) {
                var r, s, o, a, u = parseFloat(i) || 0, h = (i + "").trim().substr((u + "").length) || "px", f = tr.style, c = Pr.test(e), l = "svg" === t.tagName.toLowerCase(), v = (l ? "client" : "offset") + (c ? "Width" : "Height"), d = "px" === n, p = "%" === n;
                return n === h || !u || Er[n] || Er[h] ? u : ("px" === h || d || (u = Ln(t, e, i, "px")),
                a = t.getCTM && zn(t),
                !p && "%" !== h || !Mr[e] && !~e.indexOf("adius") ? (f[c ? "width" : "height"] = 100 + (d ? h : n),
                s = ~e.indexOf("adius") || "em" === n && t.appendChild && !l ? t : t.parentNode,
                a && (s = (t.ownerSVGElement || {}).parentNode),
                s && s !== $n && s.appendChild || (s = $n.body),
                (o = s._gsap) && p && o.width && c && o.time === Ci.time ? x(u / o.width * 100) : (!p && "%" !== h || (f.position = An(t, "position")),
                s === t && (f.position = "static"),
                s.appendChild(tr),
                r = tr[v],
                s.removeChild(tr),
                f.position = "absolute",
                c && p && ((o = y(s)).time = Ci.time,
                o.width = s[v]),
                x(d ? r * u / 100 : r && u ? 100 / r * u : 0))) : (r = a ? t.getBBox()[c ? "width" : "height"] : t[v],
                x(p ? u / r * 100 : u / 100 * r)))
            }
            function Xn(t, e, i, n) {
                var r;
                ...
                Mr[e] && "transform" !== e ? (r = Lr(t, n),
                r = "transformOrigin" !== e ? r[e] : Xr(An(t, Ar)) + " " + r.zOrigin + "px") : (r = t.style[e]) && "auto" !== r && !n && !~(r + "").indexOf("calc(") || (r = zr[e] && zr[e](t, e, i) || An(t, e) || b(t, e) || ("opacity" === e ? 1 : 0)),
            ...
            function Yn(t, e, i, n) {
                if (!i || "none" === i) {
                    var r = Rr(e, t, 1)
                      , s = r && An(t, r, 1);
                    s && s !== i ? (e = r,
                    i = s) : "borderColor" === e && (i = An(t, "borderTopColor"))
                }
                ...
                (n.match(ri) || []).length) {
                    for (; a = ri.exec(n); )
                        ...
                        l !== (c = u[b++] || "") && (h = parseFloat(c) || 0,
                        g = c.substr((h + "").length),
                        (m = "=" === l.charAt(1) ? +(l.charAt(0) + "1") : 0) && (l = l.substr(2)),
                        v = parseFloat(l),
                        p = l.substr((v + "").length),
                    ...
                    w.r = "display" === e && "none" === n ? xn : Mn;
                return si.test(n) && (w.e = 0),
                this._pt = w
            }
            function jn(t) {
                var e = t.split(" ")
            ...
            function Wn(t, e) {
                ...
                return o.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(r = t.transform.baseVal.consolidate().matrix).a, r.b, r.c, r.d, r.e, r.f]).join(",") ? Dr : u : (u !== Dr || t.offsetParent || t === Jn || o.svg || (r = a.display,
                a.display = "block",
                ...
                s && (n ? i.insertBefore(t, n) : i ? i.appendChild(t) : Jn.removeChild(t))),
                e && 6 < u.length ? [u[0], u[1], u[4], u[5], u[12], u[13]] : u)
            }
            function Zn(t, e, i, n, r, s) {
                var o, a, u, h = t._gsap, f = r || Wn(t, !0), c = h.xOrigin || 0, l = h.yOrigin || 0, v = h.xOffset || 0, d = h.yOffset || 0, p = f[0], g = f[1], m = f[2], w = f[3], y = f[4], b = f[5], M = e.split(" "), x = parseFloat(M[0]) || 0, _ = parseFloat(M[1]) || 0;
                i ? f !== Dr && (a = p * w - g * m) && (u = x * (-g / a) + _ * (p / a) - (p * b - g * y) / a,
                x = x * (w / a) + _ * (-m / a) + (m * b - w * y) / a,
                _ = u) : (x = (o = Tn(t)).x + (~M[0].indexOf("%") ? x / 100 * o.width : x),
                _ = o.y + (~(M[1] || M[0]).indexOf("%") ? _ / 100 * o.height : _)),
                n || !1 !== n && h.smooth ? (y = x - c,
                b = _ - l,
                h.xOffset = v + (y * p + b * m) - y,
                h.yOffset = d + (y * g + b * w) - b) : h.xOffset = h.yOffset = 0,
                h.xOrigin = x,
                h.yOrigin = _,
                h.smooth = !!n,
                h.origin = e,
            ...
            function qn(t, e, i, n, s, o) {
                var a, u, h = 360, f = r(s), c = parseFloat(s) * (f && ~s.indexOf("rad") ? xr : 1), l = o ? c * o : c - n, v = n + l + "deg";
                return f && ("short" === (a = s.split("_")[1]) && (l %= h) != l % 180 && (l += l < 0 ? h : -h),
                "cw" === a && l < 0 ? l = (l + 36e9) % h - ~~(l / h) * h : "ccw" === a && 0 < l && (l = (l - 36e9) % h - ~~(l / h) * h)),
            ...
            function Hn(t, e, i) {
                ...
                for (r in f.svg ? (s = i.getAttribute("transform"),
                i.setAttribute("transform", ""),
                c[Cr] = e,
                n = Lr(i, 1),
                Dn(i, Cr),
                i.setAttribute("transform", s)) : (s = getComputedStyle(i)[Cr],
                c[Cr] = e,
                n = Lr(i, 1),
                c[Cr] = s),
                Mr)
                    (s = f[r]) !== (o = n[r]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(r) < 0 && (a = G(s) !== (h = G(o)) ? Ln(i, r, s, h) : parseFloat(s),
                    u = parseFloat(o),
            ...
            Hi.version = Ni.version = gn.version = "3.6.1",
            _t = 1,
            l() && Ai();
            var $n, Jn, Kn, tr, ir, nr, rr = Ii.Power0, er = Ii.Power1, sr = Ii.Power2, or = Ii.Power3, ar = Ii.Power4, ur = Ii.Linear, hr = Ii.Quad, fr = Ii.Cubic, cr = Ii.Quart, lr = Ii.Quint, vr = Ii.Strong, dr = Ii.Elastic, pr = Ii.Back, gr = Ii.SteppedEase, mr = Ii.Bounce, wr = Ii.Sine, yr = Ii.Expo, br = Ii.Circ, Mr = {}, xr = 180 / Math.PI, _r = Math.PI / 180, Or = Math.atan2, kr = /([A-Z])/g, Pr = /(?:left|right|width|margin|padding|x)/i, Sr = /[\s,\(]\S/, Fr = {
                autoAlpha: "opacity,visibility",
                scale: "scaleX,scaleY",
                alpha: "opacity"
            }, Cr = "transform", Ar = Cr + "Origin", Ir = "O,Moz,ms,Ms,Webkit".split(","), Rr = function(t, e, i) {
                var n = (e || tr).style
                  , r = 5;
                if (t in n && !i)
                    return t;
            ...
            }, Dr = [1, 0, 0, 1, 0, 0], Br = {}, Lr = function(t, e) {
                var i = t._gsap || new Xi(t);
                if ("x"in i && !e && !i.uncache)
                    return i;
                var n, r, s, o, a, u, h, f, c, l, v, d, p, g, m, w, y, b, M, _, O, k, P, S, F, C, A, I, R, E, T, z, D = t.style, B = i.scaleX < 0, L = "deg", X = An(t, Ar) || "0";
                return n = r = s = u = h = f = c = l = v = 0,
                o = a = 1,
                i.svg = !(!t.getCTM || !zn(t)),
                g = Wn(t, i.svg),
                i.svg && (S = !i.uncache && !e && t.getAttribute("data-svg-origin"),
                ...
                n = k = g[4],
                r = P = g[5],
                6 === g.length ? (o = Math.sqrt(b * b + M * M),
                a = Math.sqrt(O * O + _ * _),
                u = b || M ? Or(M, b) * xr : 0,
                (c = _ || O ? Or(_, O) * xr + u : 0) && (a *= Math.abs(Math.cos(c * _r))),
                i.svg && (n -= d - (d * b + p * _),
                r -= p - (d * M + p * O))) : (z = g[6],
                E = g[7],
                A = g[8],
                ...
                s = g[14],
                h = (m = Or(z, R)) * xr,
                m && (S = k * (w = Math.cos(-m)) + A * (y = Math.sin(-m)),
                F = P * w + I * y,
                C = z * w + R * y,
                A = k * -y + A * w,
                I = P * -y + I * w,
                ...
                _ = C = _ * w - R * y),
                u = (m = Or(M, b)) * xr,
                m && (S = b * (w = Math.cos(m)) + M * (y = Math.sin(m)),
                F = k * w + P * y,
                M = M * w - b * y,
                P = P * w - k * y,
                b = S,
                ...
                i.forceCSS = t.setAttribute("transform", "") || !Qn(An(t, Cr)),
                S && t.setAttribute("transform", S))),
                90 < Math.abs(c) && Math.abs(c) < 270 && (B ? (o *= -1,
                c += u <= 0 ? 180 : -180,
                u += u <= 0 ? 180 : -180) : (a *= -1,
                c += c <= 0 ? 180 : -180)),
                ...
                (n || r) && (y += "translate(" + n + "%, " + r + "%) "),
                !b && s === Nr && o === Nr && a === Nr || (y += a !== Nr || b ? "translate3d(" + s + ", " + o + ", " + a + ") " : "translate(" + s + ", " + o + Qr),
                u !== jr && (y += "rotate(" + u + Qr),
                h !== jr && (y += "rotateY(" + h + Qr),
                f !== jr && (y += "rotateX(" + f + Qr),
                ...
                var i, n, r, s, o, a = e || this, u = a.xPercent, h = a.yPercent, f = a.x, c = a.y, l = a.rotation, v = a.skewX, d = a.skewY, p = a.scaleX, g = a.scaleY, m = a.target, w = a.xOrigin, y = a.yOrigin, b = a.xOffset, M = a.yOffset, _ = a.forceCSS, O = parseFloat(f), k = parseFloat(c);
                l = parseFloat(l),
                v = parseFloat(v),
                (d = parseFloat(d)) && (v += d = parseFloat(d),
                l += d),
                l || v ? (l *= _r,
                v *= _r,
                i = Math.cos(l) * p,
                ...
                s = g,
                n = r = 0),
                (O && !~(f + "").indexOf("px") || k && !~(c + "").indexOf("px")) && (O = Ln(m, "x", f, "px"),
                k = Ln(m, "y", c, "px")),
                (w || y || b || M) && (O = x(O + w - (w * i + y * r) + b),
                k = x(k + y - (w * n + y * s) + M)),
                (u || h) && (O = x(O + u / 100 * (o = m.getBBox()).width),
                k = x(k + h / 100 * o.height)),
                o = "matrix(" + i + "," + n + "," + r + "," + s + "," + O + "," + k + ")",
            ...
            var Zr, Vr, qr = {
                    ...
                    e)
                        ...
                        !li[c] || !Qi(c, e, i, n, t, r)))
                            ...
                            f)
                                ...
                                if (_ && c in _ ? (s = "function" == typeof _[c] ? _[c].call(i, n, t, r) : _[c],
                                c in Qt.units && !G(s) && (s += Qt.units[c]),
                                "=" === (s + "").charAt(1) && (s = Xn(t, c))) : s = Xn(t, c),
                                u = parseFloat(s),
                                (d = "string" === h && "=" === o.charAt(1) ? +(o.charAt(0) + "1") : 0) && (o = o.substr(2)),
                                a = parseFloat(o),
                                c in Fr && ("autoAlpha" === c && (1 === u && "hidden" === Xn(t, "visibility") && a && (u = 0),
                                Bn(this, x, "visibility", u ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)),
                                "scale" !== c && "transform" !== c && ~(c = Fr[c]).indexOf(",") && (c = c.split(",")[0])),
                                g = c in Mr)
                                    if (m || ((w = t._gsap).renderTransform && !e.parseTransform || Lr(t, e.parseTransform),
                                    y = !1 !== e.smoothOrigin && w.smooth,
                                    (m = this._pt = new cn(this._pt,x,Cr,0,1,w.renderTransform,w,0,-1)).dep = 1),
                                    "scale" === c)
                                        this._pt = new cn(this._pt,w,"scaleY",w.scaleY,d ? d * a : a - w.scaleY),
                                        M.push("scaleY", c),
                                        c += "X";
                                    else {
                                        if ("transformOrigin" === c) {
                                            o = jn(o),
                                            w.svg ? Zn(t, o, 0, y, 0, this) : ((v = parseFloat(o.split(" ")[2]) || 0) !== w.zOrigin && Bn(this, w, "zOrigin", w.zOrigin, v),
                                    ...
                                    c in x || (c = Rr(c) || c);
                                if (g || (a || 0 === a) && (u || 0 === u) && !Sr.test(o) && c in x)
                                    a = a || 0,
                                    (l = (s + "").substr((u + "").length)) !== (v = G(o) || (c in Qt.units ? Qt.units[c] : l)) && (u = Ln(t, c, s, v)),
                                    this._pt = new cn(this._pt,g ? w : x,c,u,d ? d * a : a - u,g || "px" !== v && "zIndex" !== c || !1 === e.autoRound ? mn : bn),
                                    this._pt.u = v || 0,
                                    l !== v && (this._pt.b = s,
                                    this._pt.r = yn);
                                else if (c in x)
                                    Yn.call(this, t, c, s, o);
                                else {
                                    if (!(c in t)) {
                                        p(c, o);
                                        continue
                ...
                getSetter: function(t, e, i) {
                    ...
                    e in Mr && e !== Ar && (t._gsap.x || Xn(t, "x")) ? i && ir === i ? "scale" === e ? Pn : kn : (ir = i || {}) && ("scale" === e ? Sn : Fn) : t.style && !h(t.style[e]) ? _n : ~e.indexOf("-") ? On : rn(t, e)
                },
                core: {
                    _removeProperty: Dn,
                    _getMatrix: Wn
            ...
            Vr = M("x,y,z,scale,scaleX,scaleY,xPercent,yPercent" + "," + (Zr = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", (function(t) {
                Mr[t] = 1
            }
            )),
            M(Zr, (function(t) {
            ...
            M("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY", (function(t) {
                var e = t.split(":");
                Fr[e[1]] = Vr[e[0]]
            }
            )),
    ...
    h.d("EASE", "GSAP", (function() {
        ...
        for (var n in i)
            t.registerEase(n, t.parseEase(i[n]))
    }
    )),
    h.tt = function(t, i) {
        i = i || 0;
        var n = t.innerHTML
          ...
          , u = "";
        function h() {
            o.length && (u += "<ss-word>" + o + "</ss-word>",
            o = "")
        }
        function f() {
            a.length && (o += i ? "<ss-char>" + a + "</ss-char>" : a,
            a = "")
        }
        function c() {
            r && (u = u.substring(0, r) + " " + u.substr(r),
            r = !1)
        }
