(function(t) {
    ...
    var s = t.document, h = s.documentElement, n, o, r = t.setTimeout, a = t.clearTimeout, c = i._N2, u = t.requestAnimationFrame, f = s.createElement.bind(s), l = function() {
        return f("div")
    }, d = Object.assign, m = function(t, i) {
        for (var s = Object(t), h = 1; h < arguments.length; h++) {
            var n = arguments[h];
            if (null !== n && n !== o)
                for (var r in n)
                    null !== n[r] && Object.prototype.hasOwnProperty.call(n, r) && ("object" == typeof n[r] && (n[r].constructor === Object || Array.isArray(n[r])) ? (Array.isArray(n[r]) ? s[r] = [] : ("object" != typeof s[r] || Array.isArray(s[r])) && (s[r] = {}),
                    s[r] = m(s[r], n[r])) : s[r] = n[r])
        }
        return s
    }, v = function(t, i) {
    ...
    function lt(t) {
        ...
        if (i && i.sheet) {
            ...
            for (h = n.cssRules.length - 1; h >= 0; h--)
                n.cssRules[h].selectorText && n.cssRules[h].selectorText.includes("div#n2-ss-") && n.deleteRule(h)
        }
    }
    nt((function() {
        n = s.body
    ...
    c.d("SmartSliderBackgrounds", (function() {
        ...
        t.prototype.onResized = function() {
            ...
            j(this.slider.sliderElement, "SliderDevice", function(e) {
        ...
        t.prototype.onStarterSlide = function() {
            ...
            j(this.slider.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
        }
        ,
    ...
    c.d("SmartSliderPlugins", (function() {
        ...
        return {
            ...
            addSlider: function(h) {
                if (h.plugins === o)
                    for (var n in h.plugins = new t(h),
                    i)
                        h.plugins.add(n, i[n]);
                s.push(h)
            }
    ...
    c.d("ScrollTracker", (function() {
        ...
        t.prototype.onScroll = function(e) {
            for (var t = Math.max(h.clientHeight, i.innerHeight), s = 0; s < this.items.length; s++)
    ...
    c.d("SmartSliderApi", (function() {
        ...
        t.prototype.ready = function(t, i) {
            this.sliders[t] !== o ? i.call(this.sliders[t], this.sliders[t], this.sliders[t].sliderElement) : (this.readys[t] === o && (this.readys[t] = []),
        ...
        t.prototype.trigger = function(t, i, e) {
            ...
            j(h, "layerAnimationPlayIn", function(t) {
                t.ssLastEvent = ""
            }
            .bind(this, h)));
        ...
        t.prototype.applyActionWithClick = function(e) {
            this.isClickAllowed(e) && (c._shouldPreventClick || (e.preventDefault(),
    ...
    c.d("SmartSliderAbstract", (function() {
        function t(s, h) {
            ...
            i[s] && i[s]instanceof t)
                if (i[s].__sliderElement && !n.contains(i[s].__sliderElement))
                    ...
                    if (i[s].sliderElement === o)
                        return void console.error("Slider [#" + s + "] inited multiple times");
                    if (n.contains(i[s].sliderElement))
                        return void console.error("Slider [#" + s + "] embedded multiple times")
                }
            ...
            i[s] = this,
            h.isDelayed !== o && h.isDelayed ? nt(function() {
            ...
            1 === u.length) {
                var h = []
                  , n = function() {
                    ...
                    0 === u.length && (B(h),
                    c.SmartSliderApi.off("SliderResize", n))
                };
                h.push(U(i, "resize", n, {
                    capture: !0
                })),
        ...
        t.prototype.onSliderHasDimension = function(t, i) {
            ...
            this.parameters.postBackgroundAnimations && N(this.sliderElement, "n2-ss-feature-post-bg-loader"));
            try {
        ...
        t.prototype.initUI = function() {
            ...
            if (new c.UniversalEnter(this.sliderElement,function(e) {
                ...
                G(this.sliderElement, "universalleave", function(e) {
                    e.stopPropagation(),
                    s = r(function() {
                        !1,
            ...
            n2Slow || this.isAdmin || !this.parameters.parallax.enabled || !this.parameters.parallax.mobile && (this.parameters.parallax.mobile || n2const.isMobile) || this.ready(function() {
                this.parallax = new c.LayerParallax(this,this.parameters.parallax),
            ...
            .bind(this)),
            this.parameters.blockrightclick && j(this.sliderElement, "contextmenu", (function(e) {
                e.preventDefault()
            }
            )),
            ...
            !this.killed) {
                ...
                j(this.sliderElement, "keydown", (function(t) {
                    "Space" !== t.code && "Enter" !== t.code || t.target.matches('[role="button"],[tabindex]') && t.target.matches(":not(a,input,select,textarea)") && (t.preventDefault(),
                    t.target.click(),
        ...
        t.prototype.initSlides = function() {
            ...
            for (t = 0; t < this.slides.length; t++)
                this.slides[t].init(),
                1 == +A(this.slides[t].element, "first") && (this.originalRealStarterSlide = this.slides[t]);
        ...
        t.prototype.publicDispatchEvent = function(t, i) {
            this.h(t, i),
            c.SmartSliderApi.dispatch(t, this)
        }
        ,
        t.prototype.getVisibleSlides = function(t) {
            return t === o && (t = this.currentSlide),
            [t]
        }
        ,
        ...
        t.prototype.finalizeStarterSlide = function() {
            ...
            if (this.isAdmin)
                ...
                j(this.sliderElement, "mainAnimationComplete", function(e) {
        ...
        t.prototype.finalizeStarterSlideComplete = function(t) {
            ...
            t !== o ? this.finalizeStarterSlideComplete2(t) : (this.hide(),
            G(this.sliderElement, "SliderResize", function() {
                this.finalizeStarterSlideComplete(t)
            }
            .bind(this)))
        }
        ...
        t.prototype.finalizeStarterSlideComplete2 = function(t) {
            t !== this.originalRealStarterSlide && this.originalRealStarterSlide !== o && this.originalRealStarterSlide.unsetActive(),
        ...
        t.prototype.startVisibilityCheck = function() {
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                this.it = [n.disconnect.bind(n), o.disconnect.bind(o), U(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            } else
        ...
        t.prototype._scrollTo = function(t, n) {
            var o = !1;
            return "smooth" === O(h, "scroll-behavior") && (C(h, "scroll-behavior", ""),
            o = !0),
        ...
        t.prototype.initHideArrow = function() {
            ...
            this.stages.done("StarterSlide", function() {
                t(this.currentSlide),
                j(this.sliderElement, "SliderResize", function() {
                    t(this.currentSlide)
                }
                .bind(this))
            }
                    ...
                    if (t !== this.currentSlide.index) {
                        if (this.mainAnimationLastChangeTime < n) {
                            ...
                            if ("ended" === r) {
                                ...
                                this.__fastChangeRemoveCallback = U(this.sliderElement, "mainAnimationComplete", function() {
        ...
        t.prototype.initMainAnimationWithLayerAnimation = function() {
            ...
            .bind(this)),
            j(this.sliderElement, "mainAnimationStart", this.onMainAnimationStartSyncLayers.bind(this, this.parameters.layerMode)),
            j(this.sliderElement, "reverseModeEnabled", this.onMainAnimationStartSyncLayersReverse.bind(this, this.parameters.layerMode))
        }
        ,
        ...
        t.prototype.initControls = function() {
            if (!this.parameters.admin) {
                ...
                this.parameters.controls.keyboard && (this.controls.touch !== o ? new c.SmartSliderControlKeyboard(this,this.controls.touch.axis) : new c.SmartSliderControlKeyboard(this,"horizontal")),
                this.parameters.controls.mousewheel && new c.SmartSliderControlMouseWheel(this,this.parameters.controls.mousewheel),
                this.controlAutoplay = new c.SmartSliderControlAutoplay(this,this.parameters.autoplay),
                c.SmartSliderControlFullscreen.isSupported && (this.controlFullscreen = new c.SmartSliderControlFullscreen(this)),
                this.parameters.alias.id && new c.SmartSliderControlAlias(this,this.parameters.alias)
            }
        }
        ,
        ...
        t.prototype.slideToID = function(t, i, h) {
            ...
            o)
                return this.id === o.ss.id || (et(s.scrollingElement, ht(o), 400),
        ...
        t.prototype.hide = function() {
            this.isVisible && (F(this.responsive.alignElement, "n2-ss-slider-has-no-slide"),
            this.load.placeholder && F(this.load.placeholder, "n2-ss-slider-has-no-slide"),
            this.isVisible = !1)
        }
        ,
        t.prototype.show = function() {
            this.isVisible || (F(this.responsive.alignElement, "n2-ss-slider-has-no-slide"),
            this.load.placeholder && N(this.load.placeholder, "n2-ss-slider-has-no-slide"),
            W(i, "scroll"),
            this.isVisible = !0)
        }
        ,
        t.prototype.startAutoplay = function() {
            return this.controlAutoplay !== o && (this.controlAutoplay.setState("pausedSecondary", 0),
            !0)
        }
        ,
        t.prototype.pauseAutoplay = function() {
            return this.controlAutoplay !== o && (this.controlAutoplay.setState("pausedSecondary", 1),
            !0)
        }
        ,
        t.prototype.initLayerAnimations = function() {
            ...
            j(this.sliderElement, "SliderDeviceOrientation", this._deviceSlides.bind(this)),
            j(this.sliderElement, "SliderResize", this._resizeSlides.bind(this)),
            this.isAdmin || (this.parameters.layerMode.playFirstLayer || this.currentSlide.playSpecialEventOnlySetToZero(),
        ...
        t.prototype._deviceSlides = function(e) {
            for (var t = e.detail.device, i = 0; i < this.staticSlides.length; i++)
        ...
        t.prototype._resizeSlides = function(e) {
            for (var t = e.detail.ratios, i = 0; i < this.staticSlides.length; i++)
    ...
    c.d("Stages", (function() {
        ...
        return t.prototype.get = function(t) {
            return this.stages[t] === o && (this.stages[t] = new i(t)),
            this.stages[t]
        }
        ,
    ...
    c.d("SmartSliderWidgets", (function() {
        ...
        t.prototype.onStateChangeSingle = function(t) {
            if (this.controls[t]) {
                ...
                i && this.states["hide." + t] !== o && this.states["hide." + t] && (i = !1),
        ...
        t.prototype.onReady = function() {
            ...
            this.requiredVariables = this.advancedElement ? (A(this.advancedElement, "variables") || "").split(",") : [],
            j(this.slider.sliderElement, "visibleSlidesChanged", function() {
            ...
            j(this.slider.sliderElement, "SliderResize", this.flushAdvancedVariables.bind(this))),
            this.onStateChangeAll(),
        ...
        t.prototype.flushAdvancedVariables = function() {
            ...
            for (var s in t)
                C(this.advancedElement, "--" + s, parseInt(t[s]))
        }
        ,
    ...
    c.d("SmartSliderPluginLightbox", ["SmartSliderPlugins", "litebox"], (function() {
        ...
        t.prototype.onVisible = function() {
            if (this.slider.parameters.plugins.lightbox !== o) {
                ...
                j(this.slider.sliderElement, "visibleRealSlidesChanged", this.onVisibleRealSlidesChanged.bind(this));
                var t = "click";
    ...
    c.d("SmartSliderPluginParticleJS", ["SmartSliderPlugins", "particlesJS"], (function() {
        function t(t) {
            this.slider = t,
            t.stages.done("Parameters", function() {
        ...
        t.prototype.start = function(t) {
            if (this.pJS && (this._removeListener && this._removeListener(),
            ...
            t) {
                ...
                this.pJS = c.particlesJS(this.slider.getSlideBackgroundContainer(), t),
                this._removeListener = U(this.slider.sliderElement, "SliderResize", function() {
    ...
    c.d("SmartSliderPostBackgroundAnimation", (function() {
        ...
        return s.prototype.init = function() {
            ...
            for (var t = 0; t < this.images.length; t++)
                this.images[t].onReady(this.initImage.bind(this, t, this.images[t]));
            ...
            j(this.slider.sliderElement, "mainAnimationStart", this.onMainAnimationStart.bind(this)),
            j(this.slider.sliderElement, "mainAnimationComplete", this.stop.bind(this)),
            j(this.slider.sliderElement, "SliderResize", this.onResize.bind(this)),
            j(this.slider.sliderElement, "mainAnimationWillRevertTo", this.onMainAnimationWillRevertTo.bind(this)),
            j(this.slider.sliderElement, "SlideForceChange", function(e) {
        ...
        s.prototype.onMainAnimationStart = function() {
            this.isFirst = !1,
            this.mainAnimation.hasBackgroundAnimation() || this.mainAnimation.isTouch ? G(this.slider.sliderElement, "mainAnimationComplete", this.play.bind(this)) : this.play()
        }
        ,
        ...
        s.prototype.getAnimation = function(s, h) {
            ...
            for (var d = 0; d < f.strength.length; d++) {
                var v = f.strength[d];
                "scale" === v ? (f.from.scale = 1 + (f.from.scale - 1) * i[a],
                f.to.scale = 1 + (f.to.scale - 1) * i[a]) : (f.from[v] *= i[a],
                f.to[v] *= i[a])
            }
            ...
            .bind(this, f.from.x)),
            f.from.y !== o && (f.from.y = function(t) {
                return this.ratios.slideH * t
            }
            .bind(this, f.from.y)),
            f.to.x !== o && (f.to.x = function(t) {
                return this.ratios.slideW * t
            }
            .bind(this, f.to.x)),
            f.to.y !== o && (f.to.y = function(t) {
                return this.ratios.slideH * t
            }
            .bind(this, f.to.y)),
            n2const.isFirefox && (f.from.rotationZ = .1,
            f.to.rotationZ = .1),
            c.MW.t(l, f.from),
            c.MW.flush(),
        ...
        s.prototype.prepareToSwitchSlide = function(t, i) {
            t && this.images[t.index].postBGTween ? (this.mainAnimation.hasBackgroundAnimation() && this.images[t.index].postBGTween.pause(),
            this.lastTween = this.images[t.index].postBGTween) : this.lastTween = !1,
            this.images[i.index].postBGTween ? this.tween = this.images[i.index].postBGTween : this.tween = !1
        }
        ,
    ...
    c.d("SmartSliderControlAlias", (function() {
        ...
        function t(t, s) {
            ...
            this.et && (this.ot.smoothScroll && C(h, "scroll-behavior", "smooth"),
            this.ot.slideSwitch && (this.switchOnLoad(),
            j(i, "hashchange", function() {
                var t = this.getAnchor();
                t > 0 && (1 === this.st.responsive.parameters.focusUser ? (this.st.responsive.parameters.focusUser = 0,
                this.switchToSlide(t - 1),
                this.st.responsive.parameters.focusUser = 1) : this.switchToSlide(t - 1),
                this.replaceHash())
            }
            .bind(this))))
        }
    ...
    c.d("SmartSliderControlAutoplay", (function() {
        ...
        t.prototype.onReady = function() {
            ...
            .bind(this))),
            this._listeners.push(U(t, "SlideLoaded", function(e) {
                this.wait.resolve("load")
            }
            .bind(this))),
            this._listeners.push(U(t, "BeforeCurrentSlideChange", function() {
                this.wait.resolveWeak(),
                this.setState("mainAnimationPlaying", 1)
            }
            .bind(this))),
            this._listeners.push(U(t, "mainAnimationStart", function() {
                this._currentCount++,
                this.setState("mainAnimationPlaying", 1),
                this.wait.resolveWeak()
            }
            .bind(this))),
            this._listeners.push(U(t, "mainAnimationComplete", function(e) {
            ...
            .bind(this))),
            this._listeners.push(U(t, "autoplayPause", function(e) {
                this.setState("paused", 1)
            }
            .bind(this))),
            this._listeners.push(U(t, "autoplayResume", function(e) {
            ...
            .bind(this))),
            this._listeners.push(U(t, "CurrentSlideChanged", function(e) {
        ...
        t.prototype.setState = function(t, i) {
            ...
            this.timeline !== o && (!this.state.enabled || this.state.paused || this.state.pausedSecondary || this.state.wait || this.state.mainAnimationPlaying ? (this.timeline.paused() || this.timeline.pause(),
            this.state.mainAnimationPlaying || this.isPaused !== o && this.isPaused || (this.isPaused = !0,
            this.slider.h("autoplayPaused"))) : (this.timeline.paused() && this.timeline.play(),
            (this.isPaused === o || this.isPaused) && (this.isPaused = !1,
            this.slider.h("autoplayStarted")))))
        }
        ,
        ...
        t.prototype.initHover = function(t, i) {
            if (t || i) {
                ...
                .bind(this))),
                this._listeners.push(U(this.slider.sliderElement, "mouseleave", function(e) {
        ...
        t.prototype.initMedia = function(t, i) {
            ...
            .bind(this))),
            this._listeners.push(U(s, "mediaEnded", function(e) {
    ...
    c.d("SmartSliderControlFullscreen", (function() {
        ...
        return t.isSupported = !(!s.exitFullscreen && !s.webkitExitFullscreen),
        t.isSupported && (t.requestFullscreen = h.requestFullscreen || h.webkitRequestFullscreen,
        t.exitFullscreen = s.exitFullscreen || s.webkitExitFullscreen,
        t.event = h.requestFullscreen ? "fullscreenchange" : h.webkitRequestFullscreen ? "webkitfullscreenchange" : null),
        ...
        t.prototype.fullScreenChange = function() {
            this.isDocumentInFullScreenMode() ? (this.slider.h("n2FullScreen"),
            F(h, "n2-in-fullscreen"),
            F(this.slider.sliderElement, "n2-ss-slider--fullscreen"),
            this.at = !0,
            "auto" === this._type && C(this.slider.responsive.alignElement, "max-width", "none"),
            W(i, "resize")) : (this.responsive.at = !1,
            ...
            "auto" === this._type && L(this.slider.responsive.alignElement, "max-width"),
            W(i, "resize"),
            this.at = !1,
    ...
    c.d("SmartSliderControlKeyboard", (function() {
        ...
        function o(i, s, n) {
            ...
            t || (t = new h),
            t.addControl(this),
            j(this.slider.sliderElement, "SliderKeyDown", function(e) {
        ...
        h.prototype.onKeyDown = function(e) {
            if (e.target.tagName.match(/BODY|DIV|IMG/) && !e.target.isContentEditable) {
                var t;
                if (this.mouseEvent && (t = this.findSlider(s.elementFromPoint(this.mouseEvent.clientX, this.mouseEvent.clientY))))
                    return void Z(t, "SliderKeyDown", {
                        e: e
                    });
    ...
    c.d("SmartSliderControlMouseWheel", (function() {
        ...
        t.prototype.onGlobalMouseWheel = function(e) {
            e.target.closest(".n2-ss-slider") && 0 !== e[this.ut] && (this.onCurveEvent(e),
            this.preventScroll.local || this.preventScroll.curve || Math.abs(e[this.ut]) < this.maxDelta / 2 ? e.preventDefault() : (this.preventScroll.global && e.preventDefault(),
            (this.slider.sliderElement === e.target || this.slider.sliderElement.contains(e.target)) && ("deltaY" === this.ut ? e.shiftKey || this.hasScrollableParentVertical(e.deltaY < 0, e.target) || this.onMouseWheel(e) : "deltaX" === this.ut && (this.hasScrollableParentHorizontal(e.target) || this.onMouseWheel(e)))))
        }
        ,
        t.prototype.onMouseWheel = function(e) {
            e[this.ut] < 0 ? this.slider.isChangeCarousel("previous") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.previous(),
            e.preventDefault(),
            this.startCurveWatcher(e),
            this.local(),
            this.global()) : e[this.ut] > 0 && (this.slider.isChangeCarousel("next") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.next(),
            e.preventDefault(),
            this.startCurveWatcher(e),
            this.local(),
            this.global()))
        ...
        t.prototype.onCurveEvent = function(e) {
            if (this.preventScroll.curveGlobal) {
                this.dynamicDelta || this.lastDelta === e[this.ut] || (this.lastDelta = e[this.ut],
                this.dynamicDelta = !0);
    ...
    c.d("SmartSliderControlTouch", (function() {
        ...
        function t(t) {
            ...
            j(t.sliderElement, "visibleSlidesChanged", this.onVisibleSlidesChanged.bind(this))
        }
        return t.prototype.onStarterSlide = function() {
            this.initTouch(),
            j(this.slider.sliderElement, "sliderChangeCurrentSlide", this.updatePanDirections.bind(this))
        }
        ,
        t.prototype.onVisibleSlidesChanged = function() {
        ...
        t.prototype._end = function(t, i, s, h) {
            ...
            Math.abs(s.x) < 10 && Math.abs(s.y) < 10 ? this.onTap(t) : c._preventClick()
        }
        ,
            ...
            if ("scroll" === this.currentInteraction.action && "pointer" === this.currentInteraction.type) {
                var t = this.currentInteraction.distanceY[0]
                  ...
                  , o = function() {
                    requestAnimationFrame(function() {
                        var t, i;
                        if (!this.kineticScrollCancelled && h && (t = Date.now() - n,
        ...
        t.prototype.startScrollInteraction = function(t) {
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.at || (this.currentInteraction.action = "scroll",
            "pointer" === this.currentInteraction.type && (C(h, "scroll-behavior", "auto"),
        ...
        t.prototype.onTap = function(e) {
            this.preventMultipleTap || (W(e.target, "n2click"),
    ...
    c.d("SmartSliderControlTouchHorizontal", "SmartSliderControlTouch", (function() {
        ...
        function t() {
            ...
            c.SmartSliderControlTouch.prototype.constructor.apply(this, arguments)
        }
        return t.prototype = Object.create(c.SmartSliderControlTouch.prototype),
        ...
        t.prototype.syncTouchAction = function() {
            ...
            i.PointerEventsPolyfill && p(this.swipeElement, "touch-action", t)
        }
        ,
        t
    }
    ...
    c.d("SmartSliderSlideBackgroundImage", (function() {
        ...
        t.prototype.preLoad = function() {
            ...
            "blurfit" === t && (this.blurFitMode = A(this.imageElements[0], "blurfitmode"),
    ...
    c.d("SmartSliderSlideBackgroundVideo", (function() {
        function t(t, i, s) {
            !t.slider.parameters["background.video.mobile"] && n2const.isPhone ? R(s) : n2const.isVideoAutoplayAllowed() ? (this.slide = t,
            ...
            this.promise = !1,
            i.elements.image ? this.slider.visible(this.load.bind(this)) : this.load()) : R(s)
        }
        return t.prototype.load = function() {
            if (this.video.videoWidth > 0)
                ...
                this.video.loop || j(this.video, "ended", this.onEnded.bind(this));
                var t = function() {
                    r(function() {
                ...
                .bind(this);
                this.video.n2LoadStarted === o ? j(this.video, "loadstart", t) : t(),
                this.video.load(),
                this.safePlay()
            }
        }
        ...
        t.prototype.onReady = function(e) {
            ...
            .bind(this)),
            j(this.slider.sliderElement, "mainAnimationStart", function(e) {
                this.setState("slide", this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]), !0)
            }
            .bind(this)),
            j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.setState("slide", this.slide.isActiveWhen(this.slider.slides[e.detail.currentSlideIndex]), !0)
            }
            .bind(this)),
            j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
                this.setState("slide", this.slide.isActiveWhen(e.detail.currentSlide), !0)
            }
            .bind(this)),
            A(this.video, "resetSlideChange") && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
                this.video.currentTime > 0 && -1 === this.slider.getVisibleSlides(this.slider.slides[e.detail.currentSlideIndex]).indexOf(this.slide) && (this.video.currentTime = 0,
                this.setState("ended", !1, !0))
            }
            .bind(this)),
            c.ScrollTracker.add(this.slide.element, "not-visible", function() {
        ...
        t.prototype.safePlay = function() {
            this.safeCallback(function() {
                ...
                this.promise && Promise !== o && this.promise.catch(function(e) {
        ...
        t.prototype.setState = function(t, i, s) {
            s = s || !1,
            this.state[t] = i,
            s && (this.state.ready && !this.state.ended && this.state.slide && this.state.scroll ? (this.safePlay(),
            Y(this.video, "n2playvideo")) : this.safePause())
        }
        ,
        t
    }
    ...
    c.d("SmartSliderSlideBackground", (function() {
        ...
        return t.prototype.preloadOnce = function() {
            if (!this.elements) {
                ...
                t.length && (this.elements.image = new c[this.types.image](this.slide,this.manager,this,t),
    ...
    c.d("FrontendComponentCommon", ["FrontendComponent"], (function() {
        ...
        return t.prototype = Object.create(c.FrontendComponent.prototype),
        t.prototype.constructor = t,
        ...
        t.prototype.getAnimatableElement = function() {
            if (!this.ft) {
                ...
                t && (this.ft = this.ft.querySelector(t),
        ...
        t.prototype.createLayerAnimations = function(t, i) {
            ...
            if (!n2const.isBot) {
                if (!this.skipSelfAnimation) {
                    ...
                    h.hasAnimation() ? (this.animationManager = h,
                    s.push(h)) : this.setState("InComplete", !0)
                }
        ...
        t.prototype.getParallaxNodes = function() {
            var t = [];
            return this.isVisible && (A(this.layer, "ssparallax") && t.push(this.layer),
            t.push.apply(t, c.FrontendComponent.prototype.getParallaxNodes.call(this))),
            t
        }
        ,
        t.prototype.addWrap = function(t, i) {
            return this.wraps[t] === o && (this.wraps[t] = i),
            i
        }
        ,
    ...
    c.d("FrontendComponent", (function() {
        ...
        t.prototype.initEvent = function(t, i) {
            ...
            if (h) {
                ...
                s.addEventListener(i, function(t, e) {
                    eval(t)
                }
                .bind(this, h)),
    ...
    c.d("FixedBackground", (function() {
        var t = function() {
            ...
            var s, n = Math.abs(i.orientation), o = {
                w: 0,
                h: 0
            };
            return (s = l()).style.position = "fixed",
        ...
        return {
            ...
            listeners: [],
            start: function() {
                return !this.isStarted && (this.resize(),
                this.listeners.push(U(i, "load", this.resize.bind(this))),
                this.listeners.push(U(i, "resize", this.resize.bind(this))),
                this.listeners.push(U(i, "orientationchange", this.resize.bind(this))),
                this.listeners.push(U(s, "scroll", this.render.bind(this), {
                    capture: !0,
                    passive: !0
                })),
                this.isStarted = !0,
                ...
                this.isStarted && (B(this.listeners),
                this.isStarted = !1)
            },
            ...
            renderElement: function(t) {
                var i = t.parent.getBoundingClientRect()
                  , s = 0;
                if (i.top < 0 || i.height > this.windowHeight ? s = i.top / i.height : i.bottom > this.windowHeight && (s = (i.bottom - this.windowHeight) / i.height),
                s <= 1 && s >= -1) {
                    var h = Math.round(s * (-t.data.strength * i.height)) || 0;
                    t.y !== h && (this.setY(t.animatedSMW, h),
                    t.y = h)
                }
            },
            setY: function(t, i) {
    ...
    c.d("LayerParallax", (function() {
        function t(t, i) {
            ...
            c.MW.X(t.sliderElement.querySelectorAll(".n2-ss-layers-container")).perspective = "none"),
            this.x = this.y = 0,
            this.levels = {
                1: .01,
                2: .02,
        ...
        t.prototype.enable = function() {
            ...
            this._listeners.push(U(this.sliderElement, "SliderResize", this.resize.bind(this)));
            var t = -1
              , s = -1;
            ...
            if ((this.mouseX || this.mouseY) && (this._listeners.push(U(this.sliderElement, "mouseenter", this.mouseEnter.bind(this))),
            this._listeners.push(U(this.sliderElement, "mousemove", this.mouseMove.bind(this, t, s))),
            this._listeners.push(U(this.sliderElement, "mouseleave", this.mouseLeave.bind(this, !1))),
            ...
            this.scrollY) {
                ...
                this._listeners.push(U(i, "scroll", this._scrollCallback, {
                    capture: !0,
                    passive: !0
                })),
        ...
        t.prototype.start = function(t) {
            ...
            this.firstStart) {
                if (this.parallaxedStaticSlideNodes = [],
                this.slider.staticSlides)
                    for (var i = 0; i < this.slider.staticSlides.length; i++)
                        this.parallaxedStaticSlideNodes = this.parallaxedStaticSlideNodes.concat(this.slider.staticSlides[i].getParallaxNodes());
                this.firstStart = !1
            }
            if (this.parallaxedSlideNodes = t.getParallaxNodes(),
            this.parallaxedNodes = this.parallaxedSlideNodes.concat(this.parallaxedStaticSlideNodes),
            this.parallaxedNodes.length) {
                if (this.dt = c.MW.L(this.parallaxedNodes),
        ...
        t.prototype.mouseEnter = function(e) {
            this.ticking || (c.l.add(this.lt),
            this.ticking = !0),
            this.refreshSliderDimension(),
            e && "enter" === this.parameters.origin ? this.mouseOrigin = {
                x: e.clientX,
                y: e.clientY
        ...
        t.prototype.scroll = function(t, s, h) {
            ...
            0 < this.dimensions.y + this.dimensions.h2 && n > this.dimensions.y - this.dimensions.h2 && (this.y = Math.max(s, Math.min(h, 2 * (this.dimensions.y + this.dimensions.h2) / (n + 2 * this.dimensions.h2) - 1)),
    ...
    c.d("FrontendSliderSlide", ["FrontendSliderSlideAbstract"], (function() {
        function t(t, i, s) {
            this.slides = [this],
            this.playCount = 0,
            c.FrontendSliderSlideAbstract.prototype.constructor.apply(this, arguments),
            this.id = A(i, "id"),
            ...
            this.disableFocus(),
            this.background = !1,
            t.parameters.admin ? this.minimumSlideDuration = 0 : (this.minimumSlideDuration = +A(i, "slideDuration"),
            ...
            j(t.sliderElement, "SliderDeviceOrientation", function() {
                this.slider.visibleRealSlides.push(this),
                this.isVisible = !0,
                this.slider.responsive.visibleRealSlidesChanged = !0,
                this.h("Visible")
            }
            .bind(this))) : (this.component = new c.FrontendComponentSectionSlide(this,t,i.querySelector('.n2-ss-layer[data-sstype="slide"]')),
        ...
        t.prototype.init = function() {
            ...
            t && (this.slider.isAdmin ? this.background = new c.SmartSliderSlideBackgroundAdmin(this,t,this.slider.backgrounds) : this.background = new c.SmartSliderSlideBackground(this,t,this.slider.backgrounds)),
            this.element.ssSlideBackground = this.background
        }
        ,
        t.prototype.onDeviceChange = function(t) {
            A(this.element, "hide" + ct(t)) ? !1 !== this.isVisible && (this.isVisible = !1,
            this.slider.responsive.visibleRealSlidesChanged = !0,
            this.h("Hidden")) : (this.slider.visibleRealSlides.push(this),
    ...
    c.d("FrontendSliderSlideAbstract", ["FrontendSlideControls"], (function() {
        ...
        t.prototype.setActive = function() {
            this.allowFocus(),
            F(this.element, "n2-ss-slide-active")
        }
        ,
        t.prototype.unsetActive = function() {
            this.disableFocus(),
            N(this.element, "n2-ss-slide-active")
        }
        ,
    ...
    c.d("FrontendSliderStaticSlide", ["FrontendSlideControls"], (function() {
        function t(t, i) {
            ...
            this.isVisible = !0,
            this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"),
            this.isCurrentlyEdited() ? this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]') : (this.component = new c.FrontendComponentSectionSlide(this,t,i.querySelector('.n2-ss-layer[data-sstype="slide"]')),
            this.layer = this.component.layer),
            this.init()
        }
        for (var i in c.FrontendSlideControls.prototype)
        ...
        t.prototype.onDeviceChange = function(t) {
            A(this.element, "hide" + ct(t)) ? !1 !== this.isVisible && (this.isVisible = !1,
            this.h("Hidden")) : !0 !== this.isVisible && (this.isVisible = !0,
    ...
    c.d("FrontendPlacementAbsolute", ["FrontendPlacement"], (function() {
        var t = new class {
            ...
            invalidate(t) {
                this.yt.add(t),
                1 === this.yt.size && c.l.add(this._)
            }
            O() {
                for (let t of this.yt)
                    t.vt();
                for (let t of this.yt)
                    t.onResizeSize();
                for (let t of this.yt)
        ...
        return i.prototype = Object.create(c.FrontendPlacement.prototype),
        i.prototype.constructor = i,
        i.prototype.start = function() {
            var i = this.layer.get("parentid");
            if (i) {
                var h = s.getElementById(i);
                h && (this.parentLayer = h.layer,
        ...
        i.prototype.isSingleAxis = function() {
            if (this.layer.parent instanceof c.FrontendComponentSectionSlide) {
                if (!this.parentLayer)
                    return !1;
                if (this.parentLayer.placement instanceof c.FrontendPlacementAbsolute)
                    return !1
            }
            return !0
        }
        ...
        i.prototype.onResizeSize = function() {
            ...
            u || (C(this.layer.layer, "width", o + "px"),
        ...
        i.prototype.onResizePosition = function() {
            ...
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                ...
                switch (a) {
                case "right":
                    m = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideWidth : this.wt.width,
                ...
                switch (u) {
                case "bottom":
                    v = !this.layer.slide.isStatic && this.layer.parent instanceof c.FrontendComponentSectionSlide ? this.St.slideHeight : this.wt.height,
    ...
    c.d("FrontendPlacementContent", ["FrontendPlacement"], (function() {
        ...
        return t.prototype = Object.create(c.FrontendPlacement.prototype),
        t.prototype.constructor = t,
        t
    }
    )),
    ...
    c.d("FrontendComponentCol", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            ...
            c.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.content.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype),
        t.prototype.constructor = t,
        t.prototype.getContents = function() {
            return [this.content]
        }
    ...
    c.d("FrontendComponentRow", ["FrontendComponentCommon"], (function() {
        function t(t, i, s) {
            ...
            c.FrontendComponentCommon.prototype.constructor.call(this, t, i, s, this.rowInner.querySelectorAll(":scope > .n2-ss-layer"))
        }
        return t.prototype = Object.create(c.FrontendComponentCommon.prototype),
        t.prototype.constructor = t,
        t.prototype.getContents = function() {
    ...
    c.d("FrontendComponentSectionSlide", ["FrontendComponent"], (function() {
        function t(t, i, s) {
            ...
            c.FrontendComponent.prototype.constructor.call(this, this, this, s, s.querySelectorAll(":scope > .n2-ss-layer")),
            j(i.sliderElement, "SliderDeviceOrientation", function(e) {
                this.onDeviceChange(e.detail.device.toLowerCase())
            }
            .bind(this)),
            j(i.sliderElement, "SliderResize", function(e) {
    ...
    c.d("FrontendLayerAnimationManager", (function() {
        function t(s, h, n, o) {
            ...
            this.perspective = o,
            this.perspective > 0 && (c.MW.i(this.layerElement.parentNode).perspective = this.perspective),
            this.plugins = new i
        }
        function i() {
        ...
        t.prototype.collectRelatedAnimations = function() {
            ...
            for (var t = 0; t < i.keys.length; t++) {
                var s = i.keys[t];
                this.options[s] && (this.plugins[s] || this.plugins.initPlugin(s, this.layerElement, this.animatableElement),
                this.plugins[s].collectRelatedAnimations(this.relatedAnimations, this, this.options[s]))
            }
        ...
        t.prototype.onStageReached = function(t) {
            ...
            Y(this.layerElement, t.charAt(0).toUpperCase() + t.slice(1) + "Started")
        }
        ,
        t.prototype.setEventBased = function(t, i, s) {
            ...
            h && ("object" != typeof h ? this.setOptions(JSON.parse(h)) : this.setOptions(h)),
            ...
            "" === this.options.loopPlayEvent && (this.options.loopPlayEvent = "InComplete"),
            this.buildTimeline() ? (this.updateRatios(i, s),
            ...
            .bind(this))),
            "" !== this.options.loopPauseEvent && this.subscribeEvent(this.options.loopPauseEvent, this.loop.pause.bind(this.loop)),
            "" !== this.options.loopStopEvent && this.subscribeEvent(this.options.loopStopEvent, this.loop.requestEnd.bind(this.loop, !1))) : (this.promises.loop.forceResolve(),
            ...
            .bind(this))) : this.promises.out.forceResolve(),
            this.status.set("INITIALIZED")) : this.status.set("DISABLED")
        }
        ,
        ...
        ,
        t.prototype.playSpecialEventOnlySetToZero = function() {
            this.hasSpecialEvent || ("OutForced" === this.options.outPlayEvent ? this.outStatus ? (this.status.set("LOOP_WAIT"),
            this.timeline.seek("ZERO", !0)) : (this.status.set("OUT_ENDED"),
            this.timeline.progress(1, !0)) : (this.status.set("DISABLED"),
        ...
        t.prototype.buildTimeline = function() {
            if (!this.relatedAnimations.in.length && !this.relatedAnimations.loop.length && !this.relatedAnimations.out.length)
                return !1;
            var t;
            this.timeline = new c.J({
                paused: !0
            ...
            this.linear ? this.timeline.set({}, {}, i) : (this.timeline.addPause("+=" + (.001 + i), this.promises.in.wait.bind(this.promises.in)),
            ...
            s.totalDuration() ? (this.linear || s.eventCallback("onComplete", this.inComplete.bind(this)),
            this.inStatus = !0,
            this.timeline.add(s)) : (s.kill(),
            this.inStatus = !1),
            this.timeline.addLabel("ZERO", "+=0.001"),
            this.loop = new c.AnimationsControllerLoop(this,this.layerElement),
            ...
            return h.totalDuration() ? (this.linear ? h.set({}, {}, "+=" + n) : (this.timeline.addLabel("OUT", "+=0.001"),
        ...
        t.prototype.setDevice = function(t) {
            if (this.device = t,
            this.relatedAnimations.setDevice.length > 0)
        ...
        t.prototype.refreshRatio = function(t, i) {
            if (this.updateRatios(t, i),
            this.relatedAnimations.needInvalidate) {
        ...
        t.prototype.loopComplete = function() {
            ...
            Y(this.layerElement, "LoopComplete")) : (this.promises.loop.reset(),
            ...
            for (var s = t.split(","), h = 0; h < s.length; h++)
                if (s[h].length) {
                    ...
                    case "SliderClick":
                        ...
                        j(this.slide.slider.sliderElement, o, function(e) {
                    ...
                    default:
                        ...
                        .bind(this, c)),
                        j(this.slide.element, "cancel" + o, function(t) {
                            t.killed = !0,
                            t.cancel && a(t.cancel),
                            t.cancel = r((function() {
                                t.killed = !1
    ...
    c.d("FrontendLayerAnimationsBasic", "FrontendLayerAnimationsAbstract", (function() {
        ...
        function s(i, s) {
            ...
            c.FrontendLayerAnimationsAbstract.prototype.constructor.call(this, i, s),
        ...
        s.prototype = Object.create(c.FrontendLayerAnimationsAbstract.prototype),
        ...
        s.prototype.collectRelatedAnimations = function(i, s, h) {
            ...
            this.options.in.keyFrames.length && i.in.push(new c.AnimationsRelated(this,"extendTimelineIn")),
            this.options.loop.keyFrames.length) {
                var n = new c.AnimationsLayerLoop(this,s,this.layerElement,this.It,this.options.loop);
                i.loop.push(n)
            }
            this.options.out.keyFrames.length && i.out.push(new c.AnimationsRelated(this,"extendTimelineOut")),
        ...
        s.prototype.optimizeKeyFrames = function() {
            var t, s, h = this.options.in.keyFrames, n = this.options.loop.keyFrames, o = this.options.out.keyFrames;
            ...
            this.options.in.specialZero && h.length > 0 && (this.currentZero = this._fillKeyFrame(h.pop()),
            delete this.currentZero.name,
            delete this.currentZero.duration,
            delete this.currentZero.delay,
            delete this.currentZero.ease,
            this.currentZero.transformOrigin = i(this.options.in.transformOrigin),
            ...
            for (s = 0; s < o.length; s++)
                ...
                this.prepareDeviceSpecific(t, 1);
            for (this._cleanKeyFrame(this.currentZero),
            s = 0; s < h.length; s++)
                h[s] = this._cleanKeyFrame(h[s]);
            for (s = 0; s < n.length; s++)
                n[s] = this._cleanKeyFrame(n[s]);
            for (s = 0; s < o.length; s++)
                o[s] = this._cleanKeyFrame(o[s])
        }
        ;
        var h = {
            opacity: 1,
        ...
        s.prototype.prepareDeviceSpecificProp = function(t, i, s) {
            ...
            for (h = 0; h < n.length; h++)
                i[n[h]] && i[n[h]][t] !== o && (r[n[h]] = i[n[h]][t] * s,
                a = !0);
            this.isAbsolute ? (this.requireUpdateRatios(),
            a ? (this.animationManager.needInvalidate(),
            i[t] = function(t) {
            ...
            .bind(this, r.desktopPortrait)) : a ? (this.animationManager.needInvalidate(),
            i[t] = function(t) {
            ...
            if ((i = m([], i)).length > 0) {
                ...
                if (h.length > 0)
                    for (var n = 0; n < h.length; n++)
                        this.optimizeFromTo(t, this.It, h[n].duration, h[n].from, h[n].to, s),
    ...
    c.d("FrontendLayerAnimationsReveal", "FrontendLayerAnimationsAbstract", (function() {
        ...
        return i.prototype = Object.create(c.FrontendLayerAnimationsAbstract.prototype),
        i.prototype.constructor = i,
        i.prototype.resetToEditor = function() {
            this.hasAnimation && (this.in || this.out) && (this._destroyGroup("in"),
            this._destroyGroup("out"),
            c.MW.Y(c.MW.i(this.revealedElement), ["transform", "opacity", "n2AutoAlpha"]))
        }
        ,
        i.prototype.setZero = function() {
            this.hasAnimation && (this.in || this.out) && (this.in && (this.in.clipSMW.visibility = "hidden"),
        ...
        i.prototype.collectRelatedAnimations = function(t, i, s) {
            ...
            this.in = !1,
            this.out = !1,
            s.in === o && s.out === o || (this.hasAnimation = !0,
            this.revealedElement = this.animatableElement.querySelector(".n2-ss-layer-content,.n2-ss-layer-row,.n2-ss-item,.n2-ss-item-content"),
            this.revealedElement || (this.revealedElement = l()),
            s.in !== o && (this.in = this._initGroup("in", s),
            t.in.push(new c.AnimationsRelated(this,"extendTimelineIn"))),
            s.out !== o && (this.out = this._initGroup("out", s),
            t.out.push(new c.AnimationsRelated(this,"extendTimelineOut"))))
        }
        ,
    ...
    c.d("FrontendLayerAnimationsRevealAnimation", (function() {
        var t = function(t, i, s) {
            ...
            case "circle-left":
                ...
                .bind(this, h, t);
                switch (r(i.getBoundingClientRect()),
                j(i, "RevealInternalResize", function(t, i) {
          ...
          , i = function(t, i, s, n, r, a) {
            ...
            for (var f = 0; f < c.length; f++)
                c[f].a.transformOrigin && (t.set(i[f], {
          ...
          , s = function(t, i, s, n, r, a, c) {
            ...
            for (var f = 0; f < u.length; f++)
                u[f].a.transformOrigin && (t.set(i[f], {
          ...
          , h = function(t, i) {
            ...
            case "skew-top":
                return s = i.getBoundingClientRect(),
                h = 20,
        ...
        return {
            in: function(h, r) {
                ...
                a.fromTo(r.revealedElementSMW, f, v.from, v.to)) : a.set(r.revealedElementSMW, {
                    opacity: 1
                }),
            ...
            out: function(h, r) {
                ...
                v.to.ease = "easeOutCubic",
                a.fromTo(r.revealedElementSMW, f, v.from, v.to, m - f)) : a.set(r.revealedElementSMW, {
                    opacity: 0
                }),
                m = a.totalDuration(),
                a.set(d, {
    ...
    c.d("AnimationsControllerLoop", "FrontendLayerAnimationManager", (function() {
        ...
        t.prototype.buildTimeline = function(t) {
            this.animations = [];
            for (var i = 0; i < this.animationManager.relatedAnimations.loop.length; i++)
                this.animationManager.relatedAnimations.loop[i].setController(this, i),
                this.animations.push(this.animationManager.relatedAnimations.loop[i]);
            if (this.animations.length > 0) {
                ...
                for (i = 1; i < this.animations.length; i++)
                    this.animations[i].buildTimeline(!!this.animationManager.linear && t, this.animationManager.linear ? s : 0)
            }
    ...
    c.d("AnimationsLayerLoop", ["AnimationsLoopAbstract"], (function() {
        function t(t, i, s, h, n) {
            ...
            this.single = !1,
            c.AnimationsLoopAbstract.prototype.constructor.call(this, parseInt(this.repeatCount))
        }
        return t.prototype = Object.create(c.AnimationsLoopAbstract.prototype),
        t.prototype.constructor = t,
        ...
        t.prototype.buildTimeline = function(t, i) {
            ...
            i += .001,
            this.timeline.set(this.It, {
                transformOrigin: this.transformOrigin,
                immediateRender: !1
            }, i),
            this.repeatStartDelay > 0 && (i += this.repeatStartDelay,
            this.timeline.set({}, {}, i)),
        ...
        t.prototype.buildTimelineLoop = function(t, i, s) {
            ...
            if ("linear" === i) {
                ...
                for (var a = 0; a < r; a++)
                    for (h = 0; h < n.length; h++)
                        c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, n[h].duration, d({}, n[h].from), d({
                            immediateRender: !1
                        }, n[h].to), t),
                        t += n[h].duration + (n[h].to.delay ? n[h].to.delay : 0)
            } else if ("event" === i) {
                for (this.timeline.addLabel("LOOP", t),
                h = 0; h < n.length; h++)
                    n[h].to.immediateRender = !1,
                    c.FrontendLayerAnimationManager.optimizeFromTo(this.timeline, this.It, n[h].duration, n[h].from, n[h].to, t),
                    t += n[h].duration + (n[h].to.delay ? n[h].to.delay : 0);
                this.timeline.set({}, {
        ...
        t.prototype._buildAnimationChainLoop = function(t) {
            ...
            if (1 === t.length) {
                this.single = !0;
                var s = m({}, t[0]);
                (i = d({}, this.layerAnimations.currentZero)).duration = s.duration,
                i.ease = s.ease,
                360 !== Math.abs(s.rotationX) && 360 !== Math.abs(s.rotationY) && 360 !== Math.abs(s.rotationZ) || 1 != s.opacity && s.opacity !== o || 0 != s.x && s.x !== o || 0 != s.y && s.y !== o || 0 != s.z && s.z !== o || 1 != s.scaleX && s.scaleX !== o || 1 != s.scaleY && s.scaleY !== o || 0 != s.skewX && s.skewX !== o || 0 != s.n2blur && s.n2blur !== o ? t.push(i) : (360 == +s.rotationX ? s.rotationX = "+=360" : -360 == +s.rotationX && (s.rotationX = "-=360"),
                360 == +s.rotationY ? s.rotationY = "+=360" : -360 == +s.rotationY && (s.rotationY = "-=360"),
                360 == +s.rotationZ ? s.rotationZ = "+=360" : -360 == +s.rotationZ && (s.rotationZ = "-=360"))
            }
            var h = 0
              , n = [{
    ...
    c.d("AnimationsLoopTimeline", ["AnimationsLoopAbstract"], (function() {
        ...
        t.prototype.buildTimeline = function(t, i) {
            ...
            this.controller.animationManager.linear || s.eventCallback("onComplete", function() {
    ...
    c.d("AnimationsLoopAbstract", (function() {
        ...
        t.prototype.reset = function() {
            this.resetForReplay(),
            this.index > 0 && this.timeline.pause(0)
        }
        ,
        t.prototype.resetForReplay = function() {
            this.ending = !1,
    ...
    customElements.define("ss3-fullpage", class extends HTMLElement {
        connectedCallback() {
            "100vh" !== this.dataset.basedOn && (this.Pt = i.n2Height || i.innerHeight,
            x(this, {
        ...
        updateHeight() {
            ...
            Math.abs(this.Pt - t) > (this.dataset.threshold || 0) && (C(this, "--target-height", t + "px"),
            this.Pt = t)
        }
    }
    ),
    c.d("SmartSliderResponsive", (function() {
        ...
        function f(t, s) {
            ...
            this.slider.isAdmin || "fullpage" !== this.parameters.type || this.slider.stages.done("WidgetsReady", function() {
        ...
        f.prototype.init = function() {
            ...
            t && (n2const.isVideoAutoplayAllowed() ? (t.addEventListener("error", R.bind(null, t), !0),
            t.load(),
            t.play()) : R(t))
        }
        ,
        ...
        f.prototype.start = function() {
            ...
            !this.slider.isAdmin && this.parameters.overflowHiddenPage && D([h, n], "overflow", "hidden"),
            c._smallestZoom = 320,
        ...
        f.prototype.onResize = function(e) {
            ...
            this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.Dt || (this.Dt = !0,
            G(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
        }
        ,
        ...
        f.prototype.doResize = function(e) {
            ...
            if (this.parameters.hideOn[f._DeviceMode[t]])
                return F(this.v, "n2-section-smartslider--hidden"),
                !1;
            if (N(this.v, "n2-section-smartslider--hidden"),
            !this.isVisible)
                return !1;
            var i = !1
              , s = this.device;
            ...
            this.slider.isAdmin || "fullpage" === this.parameters.type && (this.Mt = this.getVerticalOffsetHeight(),
            C(this.sliderElement, "--subtract-vertical-widget", this.Mt + "px")),
            ...
            !this.slider.visibleRealSlides.length)
                return this.parameters.hideOn[f._DeviceMode[t]] = !0,
        ...
        f.prototype.resetActiveRealSlide = function(t) {
            var i, s;
            t && t !== this.slider.currentRealSlide ? (this.slider.h("BeforeCurrentSlideChange", t),
        ...
        f.prototype.finalizeVisibleSlidesStage2 = function() {
            ...
            this.targetCurrentSlide !== o && (this.slider.h("SlideWillChange", {
    ...
    c.d("FrontendItemAnimatedHeading", (function() {
        ...
        function s(t, s) {
            if (this._t = t,
            this.Rt = Array.prototype.slice.call(this._t.querySelectorAll(".n2-ss-animated-heading-i-text")),
            this.listeners = [],
        ...
        s.prototype.started = function() {
            ...
            this.currentType.fixedWidth ? this.animateWidth = 0 == +A(this._t, "animateWidth") ? 0 : 1 : this.animateWidth = 0,
            this.delay = (+A(this._t, "delay") || 0) / 1e3,
            this.speedModifier = 1 / (Math.max(+A(this._t, "speed") || 100, 0) / 100),
            this.showDuration = Math.max(+A(this._t, "showDuration") || 1500, 0) / 1e3,
            ...
            case "animateWhole":
                var n = 0
                  , o = 0;
                this.animateWidth ? n = .4 * .8 : o = i.overlap * this.speedModifier,
                this.totalDuration = (h - 1) * this.showDuration + 2 * (h - 1) * i.duration * this.speedModifier + (h - 1) * n - (h - 1) * o;
                break;
            case "animateTypeWriter":
                for (var r = 0; r < h; r++) {
                    var a = this.getSplitTextChars(this.Rt[s === r ? 0 : r]);
                    r > 0 && (this.totalDuration += .8 + .2 * this.speedModifier + .2 * this.speedModifier * (a.length - 1)),
                    r < h - 1 && (this.totalDuration += i.backspaceDuration.call(this, a))
                }
                break;
            case "animateChars":
                for (o = 0,
                r = 0; r < h; r++) {
                    ...
                    r > 0 && (this.totalDuration += Math.max(o, i.duration * this.speedModifier + (a.length - 1) * i.stagger)),
                    r < h - 1 && (this.totalDuration += this.showDuration,
                    o = i.duration * this.speedModifier + (a.length - 1) * i.stagger)
                }
            }
            this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this))),
            j(this.slider.sliderElement, "SliderResizeHorizontal", function() {
                this.onResize()
            }
            .bind(this)),
        ...
        s.prototype.onResize = function() {
            ...
            for (var i = 0; i < this.Rt.length; i++) {
                ...
                this.currentType.fixedWidth && !this.animateWidth && (t.width = Math.max(t.width, h))
            }
            if (I(this.Rt, "n2-ss-animated-heading-measure-width"),
            this.currentType.fixedWidth && this.animateWidth) {
                let i;
                i = this.slider.isAdmin || this.loop ? this.Rt[0] : this.Rt[this.Rt.length - 1],
                this.Tt.width = +A(i, "width"),
                this.Tt.height = t.height,
                this.invalidate()
            } else
                this.Tt.width = t.width,
                this.Tt.height = t.height;
            this.refreshJustifyContent()
        }
        ,
        ...
        s.prototype.collectRelatedAnimations = function(t) {
            ...
            1 === this.loop ? (this.loopTimeline = new c.AnimationsLoopTimeline(this,0),
            i.loop.push(this.loopTimeline)) : i.in.push(new c.AnimationsRelated(this,"extendTimeline"))
        }
        ,
        ...
        s.prototype.animateChars = function(t) {
            ...
            this.animateWidth && this.timeline.set(this.Tt, {
                width: function() {
                    return A(this, "width")
                }
                .bind(this.Rt[0]),
            ...
            for (var n = 0; n < h; n++) {
                ...
                n > 0) {
                    ...
                    this.timeline.staggerFromTo(r, t.duration * this.speedModifier, d({}, t.from), d({
                        immediateRender: n < s,
                        ease: t.ease
                    }, t.current), t.stagger, a),
                    this.animateWidth && this.timeline.to(this.Tt, this.timeline.recent().duration(), {
                        width: function() {
                            return A(this, "width")
                        }
                        .bind(o)
        ...
        s.prototype.animateTypeWriter = function(t) {
            ...
            for (var h = 0; h < s; h++) {
                ...
                h < s - 1 && (t.backspace.call(this, n, this.Rt[0].parentNode),
    ...
    c.d("FrontendItemAudio", (function() {
        function t(t, i, h) {
            ...
            this.audio && (this.layerElement = this.node.closest(".n2-ss-layer"),
            ...
            n2const.isIOS ? this.prepareIOS() : j(this.audio, "volumechange", this.onVolumechange.bind(this)),
            this.audio.duration >= 0 ? this.onReady() : this.audio.addEventListener("loadedmetadata", this.onReady.bind(this)))
        }
        ...
        t.prototype.setState = function(t, i, s) {
            s = s || !1,
            this.state[t] = i,
            s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide ? this.safePlay() : this.safePause())
        }
        ,
        t.prototype.safePlay = function() {
            this.safeCallback(function() {
        ...
        t.prototype.initAutoplay = function() {
            ...
            this.setState("slide", !0, !0)) : (j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
        ...
        t.prototype.onReady = function() {
            ...
            .bind(this)),
            this.progress = this.node.querySelector(".n2-ss-item-audio-progress-container"),
            this.progress && (j(this.progress, "pointerdown", function(e) {
                e.preventDefault(),
                e.stopPropagation(),
                this.updateUITime(e);
            ...
            .bind(this)),
            this.playhead = this.progress.querySelector(".n2-ss-item-audio-progress-playhead")),
            this.volume = this.node.querySelector(".n2-ss-item-audio-volume-container"),
            this.volume && (j(this.volume, "pointerdown", function(e) {
                e.preventDefault(),
                e.stopPropagation(),
            ...
            .bind(this)),
            this.volumehead = this.volume.querySelector(".n2-ss-item-audio-volumehead")),
            ...
            this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
            ...
            .bind(this)),
            parseInt(this.parameters.reset) && j(this.slider.sliderElement, "mainAnimationComplete", function(e) {
        ...
        t.prototype.onEnded = function() {
            ...
            this.safePlay()) : (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                id: this.id
            }),
        ...
        t.prototype.onTimeUpdate = function() {
            this.updateTime(),
            this.playhead && C(this.playhead, "width", this.audio.currentTime / this.audio.duration * 100 + "%")
        }
        ,
        t.prototype.onVolumechange = function() {
            this.volumehead && C(this.volumehead, "width", 100 * this.audio.volume + "%"),
    ...
    c.d("FrontendItemBeforeAfter", (function() {
        class t {
            constructor(t, i) {
                ...
                this.jt = c.MW.i(this.Zt.querySelector(".n2-ss-item-ba-image-container--top")),
                this.Gt = c.MW.i(this.Zt.querySelector(".n2-ss-item-ba-image-container--bottom")),
                this.Xt = c.MW.i(this.Zt.querySelector(".n2-ss-item-ba-divider-container")),
                this.Ht(),
                this.qt()
            }
            qt() {
                ...
                "ontouchstart"in i && (this.Vt.classList.add("n2-ss-item-ba-container-touchaction"),
                t = "pointerdown"),
                this.Vt.addEventListener(t, (e=>{
                    ...
                    n2const.isIOS && i.TouchEvent && t.push(U(this.Vt, "touchmove", (i=>{
                        s++,
                        s > 5 && (!h && this.__preventTouchAction(e, i) ? B(t) : (i.preventDefault(),
                        h = !0))
                    }
                    ))),
                    this.setMoveEvents(e),
                    t.push(U(n, "pointermove", (e=>{
                        e.isPrimary && this.setMoveEvents(e)
                    }
                    ))),
                    t.push(U(n, "pointerup", (e=>{
                        e.isPrimary && 0 === e.button && "hover" !== this.zt && (this.Qt(e),
                        B(t))
                    }
                    ))),
                    t.push(U(n, "pointercancel", (e=>{
                        e.isPrimary && (this.Qt(e),
                        B(t))
                    }
                    ))),
                    t.push(U(this.Vt, "pointerleave", (e=>{
                        e.isPrimary && "drag" !== this.zt && (this.Qt(e),
                        B(t))
                    }
                    )))
                }
            ...
            Ht() {
                ...
                this.Ut && "hover" === this.Yt && i.matchMedia("(hover: none)").matches && (N(this.Ut, "n2-ss-item-ba-caption--show-hover"),
        ...
        class h extends t {
            setMoveEvents(e) {
                ...
                this.Gt.clipPath = "inset(0 calc(" + (100 - s) + "% - .5px) 0 0 )"
            }
            __isScrollable(t, i) {
        ...
        class o extends t {
            setMoveEvents(e) {
                ...
                this.Gt.clipPath = "inset(0 0  calc(" + (100 - s) + "% - .5px) 0)"
            }
            __isScrollable(t, i) {
                return Math.abs(t) > Math.abs(i)
            }
    ...
    c.d("FrontendItemCaption", (function() {
        function t(t, i, h, n, o, r) {
            ...
            "Fade" === h ? (this.oi.setValues({
                opacity: 0
            }),
            this.ri = this.ai,
            this.ci = this.ui) : (this.fi = {},
    ...
    c.d("FrontendItemCountdown", (function() {
        ...
        t.prototype.animate = function() {
            this.second = this.layerElement.querySelector(".n2-ss-item-countdown_second .n2-ss-item-countdown_number"),
            this.minute = this.layerElement.querySelector(".n2-ss-item-countdown_minute .n2-ss-item-countdown_number"),
            this.hour = this.layerElement.querySelector(".n2-ss-item-countdown_hour .n2-ss-item-countdown_number"),
            this.day = this.layerElement.querySelector(".n2-ss-item-countdown_day .n2-ss-item-countdown_number"),
            u(this.onUpdate.bind(this))
        }
        ,
        t.prototype.onUpdate = function() {
            let t = Math.max(0, this.vi - Math.floor((new Date).getTime() / 1e3));
            0 === t ? this.doAction() : (this.refresh(t),
            this.pi = u(this.onUpdate.bind(this)))
        }
        ,
        ...
        t.prototype.refresh = function(t) {
            ...
            const h = Math.floor(t / 60)
              , n = t -= 60 * h;
            this.bi !== i && (this.bi = i,
            this.day.innerText = this.formatNumber(i)),
            this.yi !== s && (this.yi = s,
            this.hour.innerText = this.formatNumber(s)),
            this.wi !== h && (this.wi = h,
            this.minute.innerText = this.formatNumber(h)),
            this.gi !== n && (this.gi = n,
            this.second.innerText = this.formatNumber(n))
        }
        ,
    ...
    c.d("FrontendItemCounter", (function() {
        function t(t, i, h) {
            ...
            this.data.displayMode && (this.display = n.querySelector(this.data.display)),
    ...
    c.d("FrontendItemHighlightedHeading", (function() {
        function t(t, s) {
            ...
            this.listeners = [],
            this.refreshJustifyContent(),
            j(this.slider.sliderElement, "SliderResize", this.refreshJustifyContent.bind(this)),
            this.layerElement = this.mi.closest(".n2-ss-layer"),
            this.clean(),
            n2Slow || s.disabled.layerAnimations || !A(this.mi, "animate") || n2const.isParentSameOrigin() && i.parent.tpEditorApp || (this.wrapper.querySelectorAll(".n2-ss-highlighted-heading-before,.n2-ss-highlighted-heading-after").forEach((function(t) {
                var i, s = t.innerHTML.split(" "), h = t.className, n = new DocumentFragment;
        ...
        t.prototype.started = function() {
            ...
            this.duration = Math.max(+A(this.mi, "duration") || 1500, 1) / 1e3,
            ...
            this.loop && this.loopDelay >= 0 && (this.totalDuration += this.loopDelay + .8),
            this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this)))
        }
        ,
        t.prototype.collectRelatedAnimations = function(t) {
        ...
        t.prototype.getTimeline = function() {
            if (this.timeline === o) {
                for (var t = new c.J({
                    paused: 1
                }), i = 0; i < this.paths.length; i++)
                    this.animatePath(t, this.paths[i], .6 * this.duration * i);
    ...
    c.d("FrontendItemHeadingSplitText", (function() {
        ...
        i.prototype.started = function(t, i, s, h, n, o) {
            ...
            if (s && (this.in.options = this.optimize(s.data, h),
            ...
            for (var f in (this.in.options || this.out.options) && this.listeners.push(q(this.layerElement, "collectRelatedAnimations", this.collectRelatedAnimations.bind(this))),
            c.MW.i(this.layerElement).perspective = 1e3,
            this.node.textRendering = "auto",
            u)
                u[f] && c.MW.X(this.splitText[f]).setValues({
                    "transform-origin": t,
        ...
        i.prototype.getTimelineIn = function() {
            ...
            return this._animate(this.in.timeline, i.mode, i.sort, i.duration, m({}, i.from), d(s, t), i.stagger),
            this.in.timeline
        }
        ,
        i.prototype.getTimelineOut = function() {
            ...
            return this.in.timeline && (s.immediateRender = !1),
            this._animate(this.out.timeline, i.mode, i.sort, i.duration, m({}, t), d(s, i.from), -i.stagger),
            this.out.timeline
        }
        ,
        i.prototype.collectRelatedAnimations = function(t) {
            var i = t.relatedAnimations;
            this.in.options && i.in.push(new c.AnimationsRelated(this,"extendTimelineIn")),
            this.out.options && i.out.push(new c.AnimationsRelated(this,"extendTimelineOut"))
        }
        ,
        i.prototype.extendTimelineIn = function(t) {
            var i = this.getTimelineIn();
            t.add(i, this.in.options.delay),
            i.paused(!1)
        }
        ,
        i.prototype.extendTimelineOut = function(t) {
            var i = this.getTimelineOut();
            t.add(i, this.out.options.delay),
            i.paused(!1)
        }
        ,
        ...
        i.prototype.optimize = function(t, i) {
            ...
            return 1 != t.opacity && (s.from.opacity = t.opacity),
    ...
    c.d("FrontendItemVideo", (function() {
        ...
        function i(i, h, n, o) {
            ...
            this.isStatic = this.slide.isStatic(),
            this.cover = this.playerElement.parentNode.querySelector(".n2_ss_video_player__cover");
            var r = +A(this.playerElement, "volume");
            0 === r ? (this.playerElement.volume = 1,
            this.playerElement.muted = !0) : (this.playerElement.volume = r,
            this.playerElement.muted = !1),
            this.slider.stages.done("BeforeShow", this.initVideoPlayer.bind(this))
        }
        return i.prototype.fadeOutCover = function() {
            this.coverFadedOut === o && this.cover && (this.coverFadedOut = !0,
        ...
        i.prototype.initVideoPlayer = function() {
            ...
            .bind(this)),
            j(this.playerElement, "playing", function() {
                this.isStatic || Z(this.slider.sliderElement, "mediaStarted", {
                    id: this.playerId
                }),
                Y(t, "n2play")
            ...
            .bind(this)),
            j(this.playerElement, "ended", function() {
                1 !== parseInt(this.parameters.loop) && (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                    id: this.playerId
                }),
                Y(t, "n2stop"),
                this.setState("play", !1),
                "next" === this.parameters.ended && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s),
                this.slider.next(!0)))
            }
            .bind(this)),
            j(this.playerElement, "pause", function() {
                Y(t, "n2pause"),
                this.state.continuePlay ? (this.setState("continuePlay", !1),
                this.setState("play", !0)) : this.setState("play", !1)
            }
            ...
            .bind(this))),
            "" !== this.parameters["scroll-pause"] ? c.ScrollTracker.add(this.playerElement, this.parameters["scroll-pause"], function() {
                this.setState("scroll", !0, !0)
            }
            .bind(this), function() {
            ...
            this.cover && (G(this.cover, "click", this.safePlay.bind(this)),
        ...
        i.prototype.setState = function(t, i, s) {
            s = s || !1,
            this.state[t] = i,
            s && (this.state.slideVisible && this.state.visible && this.state.play && this.state.slide && this.state.scroll ? this.safePlay() : this.safePause())
        }
        ,
    ...
    c.d("FrontendItemVimeo", (function() {
        function t(t, i, h, n, o, r) {
            ...
            1 === parseInt(this.parameters.autoplay))
                if (navigator.userAgent.toLowerCase().indexOf("android") > -1)
                    ...
                    try {
                        "playsInline"in f("video") && (this.parameters.autoplay = 1,
                        this.parameters.volume = 0)
                    } catch (t) {}
                }
        ...
        t.prototype.initVimeoPlayer = function() {
            ...
            t.src = "https://player.vimeo.com/video/" + this.parameters.vimeocode + "?autoplay=0&_video&title=" + this.parameters.title + "&byline=" + this.parameters.byline + "&background=" + this.parameters.background + "&portrait=" + this.parameters.portrait + "&color=" + this.parameters.color + "&loop=" + this.parameters.loop + ("-1" == this.parameters.quality ? "" : "&quality=" + this.parameters.quality) + "&dnt=" + this.parameters["privacy-enhanced"] + ("" !== this.parameters.privateid ? "&h=" + this.parameters.privateid : ""),
        ...
        t.prototype.onReady = function() {
            ...
            .bind(this)),
            this.cover && (n2const.isMobile && G(this.cover, "click", this.safePlay.bind(this)),
            G(i, "n2play", function() {
                c.K.to(c.MW.i(this.cover), .3, {
                    opacity: 0,
                    onComplete: function() {
            ...
            this.player.on("ended", function() {
                ...
                Y(i, "n2stop"),
                this.setState("play", !1),
                "next" === this.parameters.ended && 0 == this.parameters.loop && ((s.fullscreenElement || s.webkitFullscreenElement) && (s.exitFullscreen || s.webkitExitFullscreen).call(s),
                this.slider.next(!0))
            }
            .bind(this)),
            this.isStatic || (j(this.slider.sliderElement, "CurrentSlideChanged", function(e) {
        ...
        t.prototype.setState = function(t, i, s) {
            ...
            this.state.slideVisible && this.state.visible && this.state.slide && this.layer.isVisible ? y(this.player.element, "tabindex") : p(this.player.element, "tabindex", "-1"))
        }
        ,
        t.prototype.play = function() {
    ...
    c.d("FrontendItemYouTube", (function() {
        ...
        t.prototype.initYoutubePlayer = function() {
            var t = this.playerElement.closest(".n2-ss-layer");
            this.layer = t.layer,
            this.cover && (n2const.isMobile && G(this.cover, "click", this.play.bind(this)),
            G(t, "n2play", this.fadeOutCover.bind(this))),
            this.slide = this.slider.findSlideByElement(this.playerElement),
            this.isStatic = this.slide.isStatic();
            var h = {
            ...
            for (var n in n2const.isIOS && this.parameters.controls && (h.use_native_controls = 1),
            1 == this.parameters.center && (h.controls = 0),
            1 != this.parameters.controls && (h.autohide = 1,
            h.controls = 0),
            +(navigator.platform.toUpperCase().indexOf("MAC") >= 0 && navigator.userAgent.search("Firefox") > -1) && (h.html5 = 1),
            this.parameters.query)
                this.parameters.query.hasOwnProperty(n) && (h[n] = this.parameters.query[n]);
            var o = {
                ...
                events: {
                    ...
                    onStateChange: function(i) {
                        ...
                        case YT.PlayerState.ENDED:
                            ...
                            this.player.playVideo()) : (this.isStatic || Z(this.slider.sliderElement, "mediaEnded", {
                                id: this.playerId
                            }),
                            Y(t, "n2stop"),
                            this.setState("play", !1),
            ...
            1 == this.parameters.center && (C(this.playerElement.parentNode, "overflow", "hidden"),
            this.onResize(),
            j(this.slider.sliderElement, "SliderResize", this.onResize.bind(this)))
        }
        ,
        ...
        ,
        t.prototype.play = function() {
            this.isStopped() && (this.coverFadedOut === o && r(this.fadeOutCover.bind(this), 200),
            Z(this.slider.sliderElement, "mediaStarted", {
                id: this.playerId
            }),
