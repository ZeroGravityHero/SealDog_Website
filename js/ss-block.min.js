!function(t) {
    ...
    var s, n = t.document, h = (n.documentElement,
    t.setTimeout), o = t.clearTimeout, r = i._N2;
    ...
    ,
    "complete" === n.readyState || "interactive" === n.readyState ? s() : Document && Document.prototype && Document.prototype.addEventListener && Document.prototype.addEventListener !== n.addEventListener ? Document.prototype.addEventListener.call(n, "DOMContentLoaded", s) : n.addEventListener("DOMContentLoaded", s),
    r.d("SmartSliderBlock", ["SmartSliderAbstract"], (function() {
        ...
        return t.prototype = Object.create(r.SmartSliderAbstract.prototype),
        t.prototype.constructor = t,
        t.prototype.initResponsiveMode = function() {
            this.responsive = new r.SmartSliderResponsiveBlock(this,this.parameters.responsive),
        ...
        t.prototype.initMainAnimation = function() {
            ...
            this.isAdmin || this.disabled.postBackgroundAnimations || 0 == this.parameters.postBackgroundAnimations || (this.postBackgroundAnimation = new r.SmartSliderPostBackgroundAnimation(this,!1))
        }
        ,
    ...
    r.d("SmartSliderResponsiveBlock", ["SmartSliderResponsive"], (function() {
        function t() {
            ...
            this.o = this.sliderElement.classList.contains("n2-ss-full-page--constrain-ratio")
        }
        return t.prototype = Object.create(r.SmartSliderResponsive.prototype),
        t.prototype.constructor = t,
        ...
        t.prototype.calculateResponsiveValues = function() {
            ...
            if (this.resizeContext.sliderWidth = n.width,
            this.resizeContext.sliderHeight = n.height,
            r.SmartSliderResponsive.prototype.calculateResponsiveValues.call(this),
            this.o) {
